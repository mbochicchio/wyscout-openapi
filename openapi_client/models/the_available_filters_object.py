...
class TheAvailableFiltersObject(BaseModel):
    """
    TheAvailableFiltersObject
    """ # noqa: E501
    advsearches: Optional[List[StrictStr]] = None
    fetches: Optional[List[StrictStr]] = None
    filters: Optional[List[StrictStr]] = None
    searches: Optional[List[StrictStr]] = None
    sorts: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["advsearches", "fetches", "filters", "searches", "sorts"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "advsearches": obj.get("advsearches"),
            "fetches": obj.get("fetches"),
