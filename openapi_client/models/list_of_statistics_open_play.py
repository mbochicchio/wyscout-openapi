...
class ListOfStatisticsOpenPlay(BaseModel):
    """
    ListOfStatisticsOpenPlay
    """ # noqa: E501
    team_id: Optional[MatchAdvancedStatsOpenPlay] = Field(default=None, alias="<teamId>")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "<teamId>": MatchAdvancedStatsOpenPlay.from_dict(obj["<teamId>"]) if obj.get("<teamId>") is not None else None
        })
        return _obj
