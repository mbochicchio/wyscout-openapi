...
class MatchPhysicalDataInnerPlayersInnerMetricsInnerValuesInner(BaseModel):
    """
    MatchPhysicalDataInnerPlayersInnerMetricsInnerValuesInner
    """ # noqa: E501
    phase: Optional[StrictStr] = None
    value: Optional[Union[StrictFloat, StrictInt]] = None
    __properties: ClassVar[List[str]] = ["phase", "value"]
