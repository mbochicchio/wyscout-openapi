...
class UpdatedObjectsUpdated(BaseModel):
    """
    Info about the recently updated resources
    """ # noqa: E501
    resource_type: Optional[TheResourceObject] = Field(default=None, alias="<resourceType>")
    meta: Optional[Meta] = None
    __properties: ClassVar[List[str]] = ["&lt;resourceType&gt;", "meta"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "<resourceType>": TheResourceObject.from_dict(obj["<resourceType>"]) if obj.get("<resourceType>") is not None else None,
