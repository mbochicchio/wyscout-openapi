...
class ListOfStatisticsTransitions(BaseModel):
    """
    Transition is an event where one team loses or recovers the Ball possession.
    """ # noqa: E501
    team_id: Optional[MatchAdvancedStatsTransitions] = Field(default=None, alias="<teamId>")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "<teamId>": MatchAdvancedStatsTransitions.from_dict(obj["<teamId>"]) if obj.get("<teamId>") is not None else None
        })
        return _obj
