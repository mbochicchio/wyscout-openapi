...
class OpponentTeamDetails(BaseModel):
    """
    OpponentTeamDetails
    """ # noqa: E501
    formation: Optional[StrictStr] = Field(default=None, description="Opponent formation used at the time of the event")
    id: Optional[StrictInt] = None
    name: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["formation", "id", "name"]
