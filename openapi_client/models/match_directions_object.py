...
class MatchDirectionsObject(BaseModel):
    """
    An object containing the ids of the two teams classified by the relative direction of play
    """ # noqa: E501
    left_to_right_team_id: Optional[StrictInt] = Field(default=None, description="The id of the team playing from the left to the right", alias="leftToRightTeamId")
    right_to_left_team_id: Optional[StrictInt] = Field(default=None, description="The id of the team playing from the right to the left", alias="rightToLeftTeamId")
    __properties: ClassVar[List[str]] = ["leftToRightTeamId", "rightToLeftTeamId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "leftToRightTeamId": obj.get("leftToRightTeamId"),
            "rightToLeftTeamId": obj.get("rightToLeftTeamId")
        })
        return _obj
