...
class FormationsRelatedToTheEventSecondStartsec(BaseModel):
    """
    FormationsRelatedToTheEventSecondStartsec
    """ # noqa: E501
    scheme: Optional[MatchFormation] = Field(default=None, alias="<scheme>")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "<scheme>": MatchFormation.from_dict(obj["<scheme>"]) if obj.get("<scheme>") is not None else None
        })
        return _obj
