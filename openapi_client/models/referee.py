...
class Referee(BaseModel):
    ...
    gender: Optional[StrictStr] = Field(default=None, description="male, female")
    ...
    image_data_url: Optional[StrictStr] = Field(default=None, description="Available with querystring param `imageDataURL=true`", alias="imageDataURL")
    ...
    status: Optional[StrictStr] = Field(default=None, description="<table><thead><tr><th>Status</th><th>Description</th></tr></thead><tbody><tr><td>active</td><td>The referee is currently active</td></tr><tr><td>retired</td><td>The referee has retired</td></tr><tr><td>died</td><td>The referee is dead</td></tr></tbody></table>")
    wy_id: Optional[StrictInt] = Field(default=None, alias="wyId")
    __properties: ClassVar[List[str]] = ["birthArea", "birthDate", "firstName", "gender", "gsmId", "imageDataURL", "lastName", "middleName", "passportArea", "shortName", "status", "wyId"]
