...
class MatchFullTracking(BaseModel):
    """
    Returns link to JSON file containing Broadcast Tracking (X,Y) location data
    """ # noqa: E501
    tracking_download_url: Optional[StrictStr] = Field(default=None, alias="trackingDownloadUrl")
    wy_id: Optional[StrictInt] = Field(default=None, alias="wyId")
    __properties: ClassVar[List[str]] = ["trackingDownloadUrl", "wyId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "trackingDownloadUrl": obj.get("trackingDownloadUrl"),
            "wyId": obj.get("wyId")
        })
        return _obj
