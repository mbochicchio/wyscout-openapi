...
class TeamsStandingForTheGroup(BaseModel):
    """
    TeamsStandingForTheGroup
    """ # noqa: E501
    competition_id: Optional[StrictInt] = Field(default=None, alias="competitionId")
    game_draw: Optional[StrictInt] = Field(default=None, alias="gameDraw")
    game_lost: Optional[StrictInt] = Field(default=None, alias="gameLost")
    game_total: Optional[StrictInt] = Field(default=None, alias="gameTotal")
    ...
    __properties: ClassVar[List[str]] = ["competitionId", "gameDraw", "gameLost", "gameTotal", "gameWon", "goalAgainst", "goalPro", "groupId", "groupName", "points", "rank", "roundId", "roundName", "seasonId", "team", "teamId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "gameDraw": obj.get("gameDraw"),
            "gameLost": obj.get("gameLost"),
            "gameTotal": obj.get("gameTotal"),
