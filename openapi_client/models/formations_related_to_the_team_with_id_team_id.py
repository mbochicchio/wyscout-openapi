...
class FormationsRelatedToTheTeamWithIDTeamId(BaseModel):
    """
    FormationsRelatedToTheTeamWithIDTeamId
    """ # noqa: E501
    match_period: Optional[FormationsRelatedToThePeriodMatchPeriod] = Field(default=None, alias="<matchPeriod>")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "<matchPeriod>": FormationsRelatedToThePeriodMatchPeriod.from_dict(obj["<matchPeriod>"]) if obj.get("<matchPeriod>") is not None else None
        })
        return _obj
