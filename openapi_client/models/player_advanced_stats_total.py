...
class PlayerAdvancedStatsTotal(BaseModel):
    ...
    gk_aerial_duels: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="<i>Only Goalkeeper</i>", alias="gkAerialDuels")
    ...
    gk_clean_sheets: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Matches with no goals conceded, <i>Only Goalkeeper</i>", alias="gkCleanSheets")
    ...
    gk_saves: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="<i>Only Goalkeeper</i>", alias="gkSaves")
    ...
    matches_coming_off: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="matchesComingOff")
    matches_in_start: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="matchesInStart")
    matches_substituted: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="matchesSubstituted")
    minutes_on_field: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="minutesOnField")
    minutes_tagged: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="minutesTagged")
