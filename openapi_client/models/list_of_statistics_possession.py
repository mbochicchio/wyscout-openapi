...
class ListOfStatisticsPossession(BaseModel):
    """
    ...
    """ # noqa: E501
    team_id: Optional[MatchAdvancedStatsPossession] = Field(default=None, alias="<teamId>")
    dead_time: Optional[StrictStr] = Field(default=None, alias="deadTime")
    total_time: Optional[StrictStr] = Field(default=None, alias="totalTime")
    __properties: ClassVar[List[str]] = ["&lt;teamId&gt;", "deadTime", "totalTime"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.team_id:
            _dict['<teamId>'] = self.team_id.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "<teamId>": MatchAdvancedStatsPossession.from_dict(obj["<teamId>"]) if obj.get("<teamId>") is not None else None,
