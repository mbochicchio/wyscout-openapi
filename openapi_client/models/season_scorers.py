...
class SeasonScorers(BaseModel):
    ...
    players: Optional[List[ThePlayerObject1]] = None
    season: Optional[Season] = None
    season_id: Optional[StrictInt] = Field(default=None, alias="seasonId")
    __properties: ClassVar[List[str]] = ["competition", "competitionId", "players", "season", "seasonId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "players": [ThePlayerObject1.from_dict(_item) for _item in obj["players"]] if obj.get("players") is not None else None,
