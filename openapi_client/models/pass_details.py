...
class PassDetails(BaseModel):
    ...
    """ # noqa: E501
    accurate: Optional[StrictBool] = Field(default=None, description="If true this is an accurate pass")
    angle: Optional[StrictInt] = Field(default=None, description="For angle, 0° represents a perfect forward pass (straight line towards the goal). Passes to the right will have positive values (90° pass is a pass strictly to the right), to the left, negative (-90° pass is a pass strictly to the left). Straight back passes will have the angle of 180°. Angle is specified in degrees, taking into account standard field dimensions")
    end_location: Optional[PassEndLocation] = Field(default=None, alias="endLocation")
    length: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Length is specified in meters, taking into account standard field dimensions")
    recipient: Optional[PassRecipient] = None
    __properties: ClassVar[List[str]] = ["accurate", "angle", "endLocation", "length", "recipient"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "angle": obj.get("angle"),
            "endLocation": PassEndLocation.from_dict(obj["endLocation"]) if obj.get("endLocation") is not None else None,
            "length": obj.get("length"),
            "recipient": PassRecipient.from_dict(obj["recipient"]) if obj.get("recipient") is not None else None
        })
        return _obj
