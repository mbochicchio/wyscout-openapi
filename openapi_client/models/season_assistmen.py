...
class SeasonAssistmen(BaseModel):
    """
    ...
    players: Optional[List[ThePlayerObject]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "players": [ThePlayerObject.from_dict(_item) for _item in obj["players"]] if obj.get("players") is not None else None,
