...
class TheAppliedFiltersSchema(BaseModel):
    """
    TheAppliedFiltersSchema
    """ # noqa: E501
    advsearch: Optional[List[StrictStr]] = None
    fetch: Optional[List[StrictStr]] = None
    filter: Optional[List[StrictStr]] = None
    limit: Optional[StrictInt] = None
    page: Optional[StrictInt] = None
    search: Optional[StrictStr] = None
    sort: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["advsearch", "fetch", "filter", "limit", "page", "search", "sort"]
