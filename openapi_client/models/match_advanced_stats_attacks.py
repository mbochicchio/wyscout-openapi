...
class MatchAdvancedStatsAttacks(BaseModel):
    """
    MatchAdvancedStatsAttacks
    """ # noqa: E501
    corners: Optional[StrictInt] = None
    corners_with_shot: Optional[StrictInt] = Field(default=None, alias="cornersWithShot")
    counter_attacks: Optional[StrictInt] = Field(default=None, alias="counterAttacks")
    free_kicks: Optional[StrictInt] = Field(default=None, alias="freeKicks")
    free_kicks_with_shot: Optional[StrictInt] = Field(default=None, alias="freeKicksWithShot")
    positional_attack: Optional[StrictInt] = Field(default=None, alias="positionalAttack")
    positional_with_shots: Optional[StrictInt] = Field(default=None, alias="positionalWithShots")
    total: Optional[StrictInt] = None
    with_shots: Optional[StrictInt] = Field(default=None, alias="withShots")
    __properties: ClassVar[List[str]] = ["corners", "cornersWithShot", "counterAttacks", "freeKicks", "freeKicksWithShot", "positionalAttack", "positionalWithShots", "total", "withShots"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "cornersWithShot": obj.get("cornersWithShot"),
            "counterAttacks": obj.get("counterAttacks"),
            "freeKicks": obj.get("freeKicks"),
            "freeKicksWithShot": obj.get("freeKicksWithShot"),
            "positionalAttack": obj.get("positionalAttack"),
            "positionalWithShots": obj.get("positionalWithShots"),
            "total": obj.get("total"),
            "withShots": obj.get("withShots")
        })
        return _obj
