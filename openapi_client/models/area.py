...
class Area(BaseModel):
    ...
    """ # noqa: E501
    alpha2code: Optional[StrictStr] = None
    alpha3code: Optional[StrictStr] = None
    id: Optional[StrictInt] = None
    name: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["alpha2code", "alpha3code", "id", "name"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "alpha2code": obj.get("alpha2code"),
            "alpha3code": obj.get("alpha3code"),
            "id": obj.get("id"),
            "name": obj.get("name")
        })
        return _obj
