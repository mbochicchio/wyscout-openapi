...
class ListOfStatisticsDuels(BaseModel):
    """
    ListOfStatisticsDuels
    """ # noqa: E501
    team_id: Optional[MatchAdvancedStatsDuels] = Field(default=None, alias="<teamId>")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "<teamId>": MatchAdvancedStatsDuels.from_dict(obj["<teamId>"]) if obj.get("<teamId>") is not None else None
        })
        return _obj
