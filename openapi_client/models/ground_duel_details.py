...
class GroundDuelDetails(BaseModel):
    """
    Available when event is ground_duel
    """ # noqa: E501
    duel_type: Optional[StrictStr] = Field(default=None, description="<table><thead><tr><th>Possible duel types</th></tr></thead><tbody><tr><td>defensive_duel</td></tr><tr><td>dribble</td></tr><tr><td>offensive_duel</td></tr></tbody></table>", alias="duelType")
    kept_possession: Optional[StrictBool] = Field(default=None, description="If true this results in a kept possession", alias="keptPossession")
    opponent: Optional[OpponentDetails1] = None
    progressed_with_ball: Optional[StrictBool] = Field(default=None, description="If true this progressed with ball", alias="progressedWithBall")
    recovered_possession: Optional[StrictBool] = Field(default=None, description="If true this results in a recovered possession", alias="recoveredPossession")
    related_duel_id: Optional[StrictInt] = Field(default=None, alias="relatedDuelId")
    side: Optional[StrictStr] = None
    stopped_progress: Optional[StrictBool] = Field(default=None, description="If true this results in a stopped progression", alias="stoppedProgress")
    take_on: Optional[StrictBool] = Field(default=None, description="If true this results in a possession take on", alias="takeOn")
    __properties: ClassVar[List[str]] = ["duelType", "keptPossession", "opponent", "progressedWithBall", "recoveredPossession", "relatedDuelId", "side", "stoppedProgress", "takeOn"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "duelType": obj.get("duelType"),
            "keptPossession": obj.get("keptPossession"),
            "opponent": OpponentDetails1.from_dict(obj["opponent"]) if obj.get("opponent") is not None else None,
            "progressedWithBall": obj.get("progressedWithBall"),
            "recoveredPossession": obj.get("recoveredPossession"),
            "relatedDuelId": obj.get("relatedDuelId"),
            "side": obj.get("side"),
            "stoppedProgress": obj.get("stoppedProgress"),
            "takeOn": obj.get("takeOn")
        })
        return _obj
