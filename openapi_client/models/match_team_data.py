...
class MatchTeamData(BaseModel):
    ...
    """ # noqa: E501
    coach: Optional[Coach] = Field(default=None, description="Available with param `details=coaches`")
    coach_id: Optional[StrictInt] = Field(default=None, alias="coachId")
    formation: Optional[TeamLineupBenchedSubstitutions] = None
    has_formation: Optional[StrictInt] = Field(default=None, alias="hasFormation")
    score: Optional[StrictInt] = None
    score_et: Optional[StrictInt] = Field(default=None, alias="scoreET")
    score_ht: Optional[StrictInt] = Field(default=None, alias="scoreHT")
    score_p: Optional[StrictInt] = Field(default=None, alias="scoreP")
    side: Optional[StrictStr] = Field(default=None, description="<table><thead><tr><th>Side</th><th>Description</th></tr></thead><tbody><tr><td>home</td><td>The team was the home team for the match</td></tr><tr><td>away</td><td>The team was the away team for the match</td></tr><tr><td>none</td><td>No side was determined for this team in the match</td></tr></tbody></table>")
    team: Optional[Team] = None
    team_id: Optional[StrictInt] = Field(default=None, alias="teamId")
    __properties: ClassVar[List[str]] = ["coach", "coachId", "formation", "hasFormation", "score", "scoreET", "scoreHT", "scoreP", "side", "team", "teamId"]
    ...
    def side_validate_enum(cls, value):
        ...
        if value not in set(['home', 'away', 'none']):
            raise ValueError("must be one of enum values ('home', 'away', 'none')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "formation": TeamLineupBenchedSubstitutions.from_dict(obj["formation"]) if obj.get("formation") is not None else None,
            "hasFormation": obj.get("hasFormation"),
            "score": obj.get("score"),
            "scoreET": obj.get("scoreET"),
            "scoreHT": obj.get("scoreHT"),
            "scoreP": obj.get("scoreP"),
            "side": obj.get("side"),
