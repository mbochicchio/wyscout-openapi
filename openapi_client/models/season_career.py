...
class SeasonCareer(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["competition", "rounds", "season"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rounds": [RoundData.from_dict(_item) for _item in obj["rounds"]] if obj.get("rounds") is not None else None,
