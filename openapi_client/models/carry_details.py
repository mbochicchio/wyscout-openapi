...
class CarryDetails(BaseModel):
    """
    Available when event is a carry with the ball
    """ # noqa: E501
    end_location: Optional[CarryEndLocation] = Field(default=None, alias="endLocation")
    progression: Optional[Union[StrictFloat, StrictInt]] = None
    __properties: ClassVar[List[str]] = ["endLocation", "progression"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "endLocation": CarryEndLocation.from_dict(obj["endLocation"]) if obj.get("endLocation") is not None else None,
