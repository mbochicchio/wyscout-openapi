...
class MatchEvents(BaseModel):
    ...
    """ # noqa: E501
    elements: Optional[List[AResponseElementObject]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "elements": [AResponseElementObject.from_dict(_item) for _item in obj["elements"]] if obj.get("elements") is not None else None,
