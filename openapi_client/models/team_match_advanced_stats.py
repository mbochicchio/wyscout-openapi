...
class TeamMatchAdvancedStats(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["average", "competition", "competitionId", "match", "matchId", "percent", "round", "roundId", "season", "seasonId", "team", "teamId", "total"]
