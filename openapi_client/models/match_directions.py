...
class MatchDirections(BaseModel):
    """
    Returns the direction of attack of both teams in each half of the game
    """ # noqa: E501
    var_1_h: Optional[MatchDirectionsObject] = Field(default=None, alias="1H")
    var_2_h: Optional[MatchDirectionsObject] = Field(default=None, alias="2H")
    e1: Optional[MatchDirectionsObject] = Field(default=None, alias="E1")
    e2: Optional[MatchDirectionsObject] = Field(default=None, alias="E2")
    __properties: ClassVar[List[str]] = ["1H", "2H", "E1", "E2"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "1H": MatchDirectionsObject.from_dict(obj["1H"]) if obj.get("1H") is not None else None,
            "2H": MatchDirectionsObject.from_dict(obj["2H"]) if obj.get("2H") is not None else None,
            "E1": MatchDirectionsObject.from_dict(obj["E1"]) if obj.get("E1") is not None else None,
            "E2": MatchDirectionsObject.from_dict(obj["E2"]) if obj.get("E2") is not None else None
        })
        return _obj
