...
class MatchPhysicalDataInnerPlayersInnerMetricsInner(BaseModel):
    """
    MatchPhysicalDataInnerPlayersInnerMetricsInner
    """ # noqa: E501
    name: Optional[StrictStr] = None
    values: Optional[List[MatchPhysicalDataInnerPlayersInnerMetricsInnerValuesInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "values": [MatchPhysicalDataInnerPlayersInnerMetricsInnerValuesInner.from_dict(_item) for _item in obj["values"]] if obj.get("values") is not None else None
        })
        return _obj
