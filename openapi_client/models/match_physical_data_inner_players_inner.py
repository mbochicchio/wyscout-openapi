...
class MatchPhysicalDataInnerPlayersInner(BaseModel):
    """
    MatchPhysicalDataInnerPlayersInner
    """ # noqa: E501
    id: Optional[StrictStr] = None
    metrics: Optional[List[MatchPhysicalDataInnerPlayersInnerMetricsInner]] = None
    name: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["id", "metrics", "name"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "metrics": [MatchPhysicalDataInnerPlayersInnerMetricsInner.from_dict(_item) for _item in obj["metrics"]] if obj.get("metrics") is not None else None,
            "name": obj.get("name")
        })
        return _obj
