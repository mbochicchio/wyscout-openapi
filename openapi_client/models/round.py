...
class Round(BaseModel):
    ...
    type: Optional[StrictStr] = Field(default=None, description="<table><thead><tr><th>Type</th><th>Description</th></tr></thead><tbody><tr><td>table</td><td>The round contains a table (group or league table)</td></tr><tr><td>cup</td><td>The round contains a cup structure (knock-out)</td></tr></tbody></table>")
    wy_id: Optional[StrictInt] = Field(default=None, alias="wyId")
    __properties: ClassVar[List[str]] = ["competition", "competitionId", "endDate", "gsmId", "name", "season", "seasonId", "startDate", "type", "wyId"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['table', 'cup']):
            raise ValueError("must be one of enum values ('table', 'cup')")
        return value
