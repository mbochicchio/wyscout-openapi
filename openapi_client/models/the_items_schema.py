...
class TheItemsSchema(BaseModel):
    """
    TheItemsSchema
    """ # noqa: E501
    ...
    minutes_played: Optional[StrictInt] = Field(default=None, alias="minutesPlayed")
    penalties: Optional[StrictInt] = None
    player_id: Optional[StrictInt] = Field(default=None, alias="playerId")
    red_cards: Optional[StrictInt] = Field(default=None, alias="redCards")
    ...
    shirt_number: Optional[StrictInt] = Field(default=None, alias="shirtNumber")
    substitute_in: Optional[StrictInt] = Field(default=None, alias="substituteIn")
    substitute_on_bench: Optional[StrictInt] = Field(default=None, alias="substituteOnBench")
    substitute_out: Optional[StrictInt] = Field(default=None, alias="substituteOut")
    ...
    yellow_card: Optional[StrictInt] = Field(default=None, alias="yellowCard")
    __properties: ClassVar[List[str]] = ["appearances", "competition", "competitionId", "goal", "minutesPlayed", "penalties", "playerId", "redCards", "season", "seasonId", "shirtNumber", "substituteIn", "substituteOnBench", "substituteOut", "team", "teamId", "yellowCard"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "goal": obj.get("goal"),
            "minutesPlayed": obj.get("minutesPlayed"),
            ...
            "shirtNumber": obj.get("shirtNumber"),
            "substituteIn": obj.get("substituteIn"),
            "substituteOnBench": obj.get("substituteOnBench"),
            "substituteOut": obj.get("substituteOut"),
            "team": Team.from_dict(obj["team"]) if obj.get("team") is not None else None,
            "teamId": obj.get("teamId"),
            "yellowCard": obj.get("yellowCard")
        })
        return _obj
