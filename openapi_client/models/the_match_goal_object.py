...
class TheMatchGoalObject(BaseModel):
    """
    TheMatchGoalObject
    """ # noqa: E501
    minute: Optional[StrictInt] = None
    period: Optional[StrictStr] = Field(default=None, description="<table><thead><tr><th>Period</th></tr></thead><tbody><tr><td>FirstHalf</td></tr><tr><td>SecondHalf</td></tr><tr><td>ExtraFirstHalf</td></tr><tr><td>ExtraSecondHalf</td></tr><tr><td>Shootout</td></tr></tbody></table>")
    player: Optional[Player] = Field(default=None, description="Available with querystring param `details=players`")
    player_id: Optional[StrictInt] = Field(default=None, alias="playerId")
    team: Optional[Team] = Field(default=None, description="Available with querystring param `details=teams`")
    team_id: Optional[StrictInt] = Field(default=None, alias="teamId")
    type: Optional[StrictStr] = Field(default=None, description="<table><thead><tr><th>Type</th><th>Description</th></tr></thead><tbody><tr><td>goal</td><td>Generic goal</td></tr><tr><td>own</td><td>Own goal</td></tr><tr><td>penalty</td><td>Penalty goal</td></tr></tbody></table>")
    __properties: ClassVar[List[str]] = ["minute", "period", "player", "playerId", "team", "teamId", "type"]
    ...
    def period_validate_enum(cls, value):
        ...
        if value not in set(['FirstHalf', 'SecondHalf', 'ExtraFirstHalf', 'ExtraSecondHalf', 'Shootout']):
            raise ValueError("must be one of enum values ('FirstHalf', 'SecondHalf', 'ExtraFirstHalf', 'ExtraSecondHalf', 'Shootout')")
        return value
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['goal', 'own', 'penalty']):
            raise ValueError("must be one of enum values ('goal', 'own', 'penalty')")
        return value
