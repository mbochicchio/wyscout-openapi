...
class TeamAdvancedStatsPercent(BaseModel):
    """
    ...
    head_shots_on_target: Optional[StrictInt] = Field(default=None, alias="headShotsOnTarget")
    ...
    penalties_conversion: Optional[StrictInt] = Field(default=None, description="Penalties converted into a goal", alias="penaltiesConversion")
    ...
    successful_shot_assists: Optional[StrictInt] = Field(default=None, alias="successfulShotAssists")
    ...
    successful_touch_in_box: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="successfulTouchInBox")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "successfulTouchInBox": obj.get("successfulTouchInBox"),
