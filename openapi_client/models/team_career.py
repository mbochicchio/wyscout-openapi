...
class TeamCareer(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "career": [TheTeamCareerArrayInner.from_dict(_item) for _item in obj["career"]] if obj.get("career") is not None else None,
