...
class TeamSquad(BaseModel):
    ...
    """ # noqa: E501
    coach: Optional[List[Coach]] = None
    squad: Optional[List[Player]] = None
    staff: Optional[List[Coach]] = None
    team: Optional[Team] = Field(default=None, description="Available with querystring param `fetch=team`")
    __properties: ClassVar[List[str]] = ["coach", "squad", "staff", "team"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in coach (list)
        _items = []
        if self.coach:
            for _item_coach in self.coach:
                if _item_coach:
                    _items.append(_item_coach.to_dict())
            _dict['coach'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "coach": [Coach.from_dict(_item) for _item in obj["coach"]] if obj.get("coach") is not None else None,
            "squad": [Player.from_dict(_item) for _item in obj["squad"]] if obj.get("squad") is not None else None,
            "staff": [Coach.from_dict(_item) for _item in obj["staff"]] if obj.get("staff") is not None else None,
