...
class MatchAdvancedStatsDuels(BaseModel):
    """
    ...
    aerial_duels_successful: Optional[StrictInt] = Field(default=None, alias="aerialDuelsSuccessful")
    challenge_intensity: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Number of defensive actions (defensive duels, loose ball duels, interceptions, tackles) per minute of opponent ball possession", alias="challengeIntensity")
    ...
    defensive_duels_successful: Optional[StrictInt] = Field(default=None, alias="defensiveDuelsSuccessful")
    ...
    dribbles_successful: Optional[StrictInt] = Field(default=None, alias="dribblesSuccessful")
    ...
    duels_successful: Optional[StrictInt] = Field(default=None, alias="duelsSuccessful")
    ground_duels: Optional[StrictInt] = Field(default=None, alias="groundDuels")
    ground_duels_successful: Optional[StrictInt] = Field(default=None, alias="groundDuelsSuccessful")
    ...
    loose_ball_duels_successful: Optional[StrictInt] = Field(default=None, alias="looseBallDuelsSuccessful")
    ...
    offensive_duels_successful: Optional[StrictInt] = Field(default=None, alias="offensiveDuelsSuccessful")
    __properties: ClassVar[List[str]] = ["aerialDuels", "aerialDuelsSuccessful", "challengeIntensity", "defensiveDuels", "defensiveDuelsSuccessful", "dribbles", "dribblesSuccessful", "duels", "duelsSuccessful", "groundDuels", "groundDuelsSuccessful", "looseBallDuels", "looseBallDuelsSuccessful", "offensiveDuels", "offensiveDuelsSuccessful"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "aerialDuelsSuccessful": obj.get("aerialDuelsSuccessful"),
            "challengeIntensity": obj.get("challengeIntensity"),
            "defensiveDuels": obj.get("defensiveDuels"),
            "defensiveDuelsSuccessful": obj.get("defensiveDuelsSuccessful"),
            "dribbles": obj.get("dribbles"),
            "dribblesSuccessful": obj.get("dribblesSuccessful"),
            "duels": obj.get("duels"),
            "duelsSuccessful": obj.get("duelsSuccessful"),
            "groundDuels": obj.get("groundDuels"),
            "groundDuelsSuccessful": obj.get("groundDuelsSuccessful"),
            "looseBallDuels": obj.get("looseBallDuels"),
            "looseBallDuelsSuccessful": obj.get("looseBallDuelsSuccessful"),
            "offensiveDuels": obj.get("offensiveDuels"),
            "offensiveDuelsSuccessful": obj.get("offensiveDuelsSuccessful")
        })
        return _obj
