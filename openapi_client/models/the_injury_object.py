...
class TheInjuryObject(BaseModel):
    """
    TheInjuryObject
    """ # noqa: E501
    description: Optional[StrictStr] = None
    from_date: Optional[StrictStr] = Field(default=None, alias="fromDate")
    games_missed: Optional[StrictInt] = Field(default=None, alias="gamesMissed")
    id: Optional[StrictInt] = None
    injury_localization: Optional[StrictStr] = Field(default=None, alias="injuryLocalization")
    injury_side: Optional[StrictStr] = Field(default=None, alias="injurySide")
    injury_type: Optional[StrictStr] = Field(default=None, alias="injuryType")
    is_disease: Optional[StrictInt] = Field(default=None, alias="isDisease")
    player_id: Optional[StrictInt] = Field(default=None, alias="playerId")
    __properties: ClassVar[List[str]] = ["description", "fromDate", "gamesMissed", "id", "injuryLocalization", "injurySide", "injuryType", "isDisease", "playerId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "gamesMissed": obj.get("gamesMissed"),
            "id": obj.get("id"),
            "injuryLocalization": obj.get("injuryLocalization"),
            "injurySide": obj.get("injurySide"),
            "injuryType": obj.get("injuryType"),
