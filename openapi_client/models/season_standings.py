...
class SeasonStandings(BaseModel):
    ...
    teams: Optional[List[TheTeamObject]] = None
    __properties: ClassVar[List[str]] = ["competition", "competitionId", "roundId", "season", "seasonId", "teams"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "teams": [TheTeamObject.from_dict(_item) for _item in obj["teams"]] if obj.get("teams") is not None else None
        })
        return _obj
