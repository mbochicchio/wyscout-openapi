...
class TheTeamObject(BaseModel):
    ...
    total_draws: Optional[StrictInt] = Field(default=None, alias="totalDraws")
    total_goals_against: Optional[StrictInt] = Field(default=None, alias="totalGoalsAgainst")
    total_goals_for: Optional[StrictInt] = Field(default=None, alias="totalGoalsFor")
    total_losses: Optional[StrictInt] = Field(default=None, alias="totalLosses")
    total_played: Optional[StrictInt] = Field(default=None, alias="totalPlayed")
    total_points: Optional[StrictInt] = Field(default=None, alias="totalPoints")
    total_wins: Optional[StrictInt] = Field(default=None, alias="totalWins")
    __properties: ClassVar[List[str]] = ["groupName", "team", "teamId", "totalDraws", "totalGoalsAgainst", "totalGoalsFor", "totalLosses", "totalPlayed", "totalPoints", "totalWins"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "totalDraws": obj.get("totalDraws"),
            "totalGoalsAgainst": obj.get("totalGoalsAgainst"),
            "totalGoalsFor": obj.get("totalGoalsFor"),
            "totalLosses": obj.get("totalLosses"),
            "totalPlayed": obj.get("totalPlayed"),
            "totalPoints": obj.get("totalPoints"),
            "totalWins": obj.get("totalWins")
        })
        return _obj
