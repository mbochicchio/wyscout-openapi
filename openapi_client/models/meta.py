...
class Meta(BaseModel):
    ...
    Meta
    """ # noqa: E501
    applied_filters: Optional[TheAppliedFiltersSchema] = Field(default=None, alias="appliedFilters")
    available_filters: Optional[TheAvailableFiltersObject] = Field(default=None, alias="availableFilters")
    page_count: Optional[StrictInt] = None
    page_current: Optional[StrictInt] = None
    page_size: Optional[StrictInt] = None
    total_items: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["appliedFilters", "availableFilters", "page_count", "page_current", "page_size", "total_items"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.applied_filters:
            _dict['appliedFilters'] = self.applied_filters.to_dict()
        # override the default output from pydantic by calling `to_dict()` of available_filters
        if self.available_filters:
            _dict['availableFilters'] = self.available_filters.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "appliedFilters": TheAppliedFiltersSchema.from_dict(obj["appliedFilters"]) if obj.get("appliedFilters") is not None else None,
            "availableFilters": TheAvailableFiltersObject.from_dict(obj["availableFilters"]) if obj.get("availableFilters") is not None else None,
            "page_count": obj.get("page_count"),
            "page_current": obj.get("page_current"),
