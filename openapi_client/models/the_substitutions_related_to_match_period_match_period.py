...
class TheSubstitutionsRelatedToMatchPeriodMatchPeriod(BaseModel):
    """
    TheSubstitutionsRelatedToMatchPeriodMatchPeriod
    """ # noqa: E501
    start_sec: Optional[TheSubstitutionThatHappenedAtStartSecSecondsElapsedFromTheStart] = Field(default=None, alias="<startSec>")
    __properties: ClassVar[List[str]] = ["&lt;startSec&gt;"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of start_sec
        if self.start_sec:
            _dict['<startSec>'] = self.start_sec.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "<startSec>": TheSubstitutionThatHappenedAtStartSecSecondsElapsedFromTheStart.from_dict(obj["<startSec>"]) if obj.get("<startSec>") is not None else None
        })
        return _obj
