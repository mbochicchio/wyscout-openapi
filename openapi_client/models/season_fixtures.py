...
class SeasonFixtures(BaseModel):
    """
    ...
    matches: Optional[List[TheMatchObject]] = None
    ...
    __properties: ClassVar[List[str]] = ["competition", "competitionId", "matches", "season", "seasonId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "matches": [TheMatchObject.from_dict(_item) for _item in obj["matches"]] if obj.get("matches") is not None else None,
