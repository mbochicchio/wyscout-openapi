...
class PlayersFetch(BaseModel):
    """
    Available with querystring param `fetch=players`
    """ # noqa: E501
    team_id: Optional[List[Player]] = Field(default=None, alias="<teamId>")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in team_id (list)
        _items = []
        if self.team_id:
            for _item_team_id in self.team_id:
                if _item_team_id:
                    _items.append(_item_team_id.to_dict())
            _dict['<teamId>'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "<teamId>": [Player.from_dict(_item) for _item in obj["<teamId>"]] if obj.get("<teamId>") is not None else None
        })
        return _obj
