...
class TheTransferObject(BaseModel):
    """
    TheTransferObject
    """ # noqa: E501
    ...
    teams_data: Optional[TeamsDetails] = Field(default=None, alias="teamsData")
    ...
    __properties: ClassVar[List[str]] = ["active", "announceDate", "currency", "endDate", "fromTeamId", "fromTeamName", "player", "playerId", "startDate", "teamsData", "toTeamId", "toTeamName", "type", "value"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "teamsData": TeamsDetails.from_dict(obj["teamsData"]) if obj.get("teamsData") is not None else None,
