...
class TheMatchObject(BaseModel):
    """
    TheMatchObject
    """ # noqa: E501
    goals: Optional[List[TheMatchGoalObject]] = None
    match: Optional[Match] = None
    match_id: Optional[StrictInt] = Field(default=None, alias="matchId")
    __properties: ClassVar[List[str]] = ["goals", "match", "matchId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "goals": [TheMatchGoalObject.from_dict(_item) for _item in obj["goals"]] if obj.get("goals") is not None else None,
