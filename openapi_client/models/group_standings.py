...
class GroupStandings(BaseModel):
    ...
    GroupStandings
    """ # noqa: E501
    teams: Optional[List[TeamsStandingForTheGroup]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "teams": [TeamsStandingForTheGroup.from_dict(_item) for _item in obj["teams"]] if obj.get("teams") is not None else None
        })
        return _obj
