...
class VideoOffsets(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "offsets": Offsets.from_dict(obj["offsets"]) if obj.get("offsets") is not None else None
        })
        return _obj
