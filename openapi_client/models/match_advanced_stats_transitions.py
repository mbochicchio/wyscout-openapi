...
class MatchAdvancedStatsTransitions(BaseModel):
    """
    MatchAdvancedStatsTransitions
    """ # noqa: E501
    losses_high: Optional[StrictInt] = Field(default=None, alias="lossesHigh")
    losses_low: Optional[StrictInt] = Field(default=None, alias="lossesLow")
    losses_medium: Optional[StrictInt] = Field(default=None, alias="lossesMedium")
    losses_total: Optional[StrictInt] = Field(default=None, alias="lossesTotal")
    ...
    recoveries_high: Optional[StrictInt] = Field(default=None, alias="recoveriesHigh")
    recoveries_low: Optional[StrictInt] = Field(default=None, alias="recoveriesLow")
    recoveries_medium: Optional[StrictInt] = Field(default=None, alias="recoveriesMedium")
    recoveries_total: Optional[StrictInt] = Field(default=None, alias="recoveriesTotal")
    __properties: ClassVar[List[str]] = ["lossesHigh", "lossesLow", "lossesMedium", "lossesTotal", "opponentHalfRecoveries", "ownHalfLosses", "recoveriesHigh", "recoveriesLow", "recoveriesMedium", "recoveriesTotal"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "lossesHigh": obj.get("lossesHigh"),
            "lossesLow": obj.get("lossesLow"),
            "lossesMedium": obj.get("lossesMedium"),
            "lossesTotal": obj.get("lossesTotal"),
            "opponentHalfRecoveries": obj.get("opponentHalfRecoveries"),
            "ownHalfLosses": obj.get("ownHalfLosses"),
            "recoveriesHigh": obj.get("recoveriesHigh"),
            "recoveriesLow": obj.get("recoveriesLow"),
            "recoveriesMedium": obj.get("recoveriesMedium"),
            "recoveriesTotal": obj.get("recoveriesTotal")
        })
        return _obj
