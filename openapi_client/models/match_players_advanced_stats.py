...
class MatchPlayersAdvancedStats(BaseModel):
    """
    Returns advanced statistics of all players in a specific match
    """ # noqa: E501
    players: Optional[List[PlayerMatchAdvancedStats]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "players": [PlayerMatchAdvancedStats.from_dict(_item) for _item in obj["players"]] if obj.get("players") is not None else None
        })
        return _obj
