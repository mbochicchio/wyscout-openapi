...
class MatchRefereesInner(BaseModel):
    ...
    def role_validate_enum(cls, value):
        ...
        if value not in set(['referee', 'firstAssistant', 'secondAssistant', 'fourthOfficial', 'firstAdditionalAssistant', 'secondAdditionalAssistant']):
            raise ValueError("must be one of enum values ('referee', 'firstAssistant', 'secondAssistant', 'fourthOfficial', 'firstAdditionalAssistant', 'secondAdditionalAssistant')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "referee": Referee.from_dict(obj["referee"]) if obj.get("referee") is not None else None,
