...
class FormationsFetch(BaseModel):
    """
    Available with querystring param `fetch=formations`
    """ # noqa: E501
    team_id: Optional[FormationsRelatedToTheTeamWithIDTeamId] = Field(default=None, alias="<teamId>")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "<teamId>": FormationsRelatedToTheTeamWithIDTeamId.from_dict(obj["<teamId>"]) if obj.get("<teamId>") is not None else None
        })
        return _obj
