...
class TeamSubstitutionsInner(BaseModel):
    """
    ...
    player_in: Optional[StrictInt] = Field(default=None, alias="playerIn")
    player_out: Optional[StrictInt] = Field(default=None, alias="playerOut")
    __properties: ClassVar[List[str]] = ["assists", "minute", "playerIn", "playerOut"]
