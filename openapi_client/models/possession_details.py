...
class PossessionDetails(BaseModel):
    """
    ...
    end_location: Optional[PossessionEndLocation] = Field(default=None, alias="endLocation")
    event_index: Optional[StrictInt] = Field(default=None, alias="eventIndex")
    events_number: Optional[StrictInt] = Field(default=None, alias="eventsNumber")
    id: Optional[StrictInt] = None
    start_location: Optional[PossessionStartLocation] = Field(default=None, alias="startLocation")
    team: Optional[TeamDetails] = None
    types: Optional[List[StrictStr]] = Field(default=None, description="<table><thead><tr><th>Possible type values</th></tr></thead><tbody><tr><td>corner</td></tr><tr><td>counterattack</td></tr><tr><td>set_piece_attack</td></tr><tr><td>attack</td></tr><tr><td>free_kick</td></tr><tr><td>direct_free_kick</td></tr><tr><td>penalty</td></tr><tr><td>throw_in</td></tr><tr><td>free_kick_cross</td></tr><tr><td>transition_low</td></tr><tr><td>transition_medium</td></tr><tr><td>transition_high</td></tr></tbody></table>")
    __properties: ClassVar[List[str]] = ["attack", "duration", "endLocation", "eventIndex", "eventsNumber", "id", "startLocation", "team", "types"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "attack": AttackDetails.from_dict(obj["attack"]) if obj.get("attack") is not None else None,
            "duration": obj.get("duration"),
            "endLocation": PossessionEndLocation.from_dict(obj["endLocation"]) if obj.get("endLocation") is not None else None,
            "eventIndex": obj.get("eventIndex"),
            "eventsNumber": obj.get("eventsNumber"),
            "id": obj.get("id"),
            "startLocation": PossessionStartLocation.from_dict(obj["startLocation"]) if obj.get("startLocation") is not None else None,
            "team": TeamDetails.from_dict(obj["team"]) if obj.get("team") is not None else None,
            "types": obj.get("types")
        })
        return _obj
