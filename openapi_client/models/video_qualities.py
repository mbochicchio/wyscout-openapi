...
class VideoQualities(BaseModel):
    """
    Information about the existing qualities for a given video
    """ # noqa: E501
    fullhd: Optional[TheFullhdObject] = None
    hd: Optional[TheHdObject] = None
    lq: Optional[TheLqObject] = None
    match_id: Optional[StrictInt] = Field(default=None, alias="matchId")
    sd: Optional[TheSdObject] = None
    __properties: ClassVar[List[str]] = ["fullhd", "hd", "lq", "matchId", "sd"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "fullhd": TheFullhdObject.from_dict(obj["fullhd"]) if obj.get("fullhd") is not None else None,
            "hd": TheHdObject.from_dict(obj["hd"]) if obj.get("hd") is not None else None,
            "lq": TheLqObject.from_dict(obj["lq"]) if obj.get("lq") is not None else None,
            "matchId": obj.get("matchId"),
            "sd": TheSdObject.from_dict(obj["sd"]) if obj.get("sd") is not None else None
        })
        return _obj
