...
class AttackDetails(BaseModel):
    ...
    AttackDetails
    """ # noqa: E501
    flank: Optional[StrictStr] = Field(default=None, description="<table><thead><tr><th>Possible flank values</th></tr></thead><tbody><tr><td>left</td></tr><tr><td>right</td></tr><tr><td>center</td></tr></tbody></table>")
    with_goal: Optional[StrictBool] = Field(default=None, description="If true this is an attack with goal", alias="withGoal")
    with_shot: Optional[StrictBool] = Field(default=None, description="If true this is an attack with shot", alias="withShot")
    with_shot_on_goal: Optional[StrictBool] = Field(default=None, description="If true this is an attack with shot on goal", alias="withShotOnGoal")
    xg: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["flank", "withGoal", "withShot", "withShotOnGoal", "xg"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "flank": obj.get("flank"),
            "withGoal": obj.get("withGoal"),
            "withShot": obj.get("withShot"),
            "withShotOnGoal": obj.get("withShotOnGoal"),
            "xg": obj.get("xg")
        })
        return _obj
