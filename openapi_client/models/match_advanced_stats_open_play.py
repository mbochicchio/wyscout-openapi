...
class MatchAdvancedStatsOpenPlay(BaseModel):
    """
    MatchAdvancedStatsOpenPlay
    """ # noqa: E501
    long: Optional[StrictInt] = None
    medium: Optional[StrictInt] = None
    short: Optional[StrictInt] = None
    total: Optional[StrictInt] = None
    very_long: Optional[StrictInt] = Field(default=None, alias="veryLong")
    __properties: ClassVar[List[str]] = ["long", "medium", "short", "total", "veryLong"]
