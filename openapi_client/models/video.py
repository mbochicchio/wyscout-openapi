...
class Video(BaseModel):
    ...
    """ # noqa: E501
    fullhd: Optional[QualityUrl] = None
    hd: Optional[QualityUrl] = None
    lq: Optional[QualityUrl] = None
    match_id: Optional[StrictInt] = Field(default=None, alias="matchId")
    offsets: Optional[InformationAboutVideoOffsets] = None
    sd: Optional[QualityUrl] = None
    __properties: ClassVar[List[str]] = ["fullhd", "hd", "lq", "matchId", "offsets", "sd"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of fullhd
        if self.fullhd:
            _dict['fullhd'] = self.fullhd.to_dict()
        # override the default output from pydantic by calling `to_dict()` of hd
        if self.hd:
            _dict['hd'] = self.hd.to_dict()
        # override the default output from pydantic by calling `to_dict()` of lq
        if self.lq:
            _dict['lq'] = self.lq.to_dict()
        # override the default output from pydantic by calling `to_dict()` of offsets
        if self.offsets:
            _dict['offsets'] = self.offsets.to_dict()
        # override the default output from pydantic by calling `to_dict()` of sd
        if self.sd:
            _dict['sd'] = self.sd.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "fullhd": QualityUrl.from_dict(obj["fullhd"]) if obj.get("fullhd") is not None else None,
            "hd": QualityUrl.from_dict(obj["hd"]) if obj.get("hd") is not None else None,
            "lq": QualityUrl.from_dict(obj["lq"]) if obj.get("lq") is not None else None,
            "matchId": obj.get("matchId"),
            "offsets": InformationAboutVideoOffsets.from_dict(obj["offsets"]) if obj.get("offsets") is not None else None,
            "sd": QualityUrl.from_dict(obj["sd"]) if obj.get("sd") is not None else None
        })
        return _obj
