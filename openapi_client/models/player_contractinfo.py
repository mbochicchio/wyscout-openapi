...
class PlayerContractinfo(BaseModel):
    ...
    """ # noqa: E501
    agencies: Optional[List[StrictStr]] = None
    contract_expiration: Optional[StrictStr] = Field(default=None, alias="contractExpiration")
    player: Optional[Player] = None
    player_id: Optional[StrictInt] = Field(default=None, alias="playerId")
    __properties: ClassVar[List[str]] = ["agencies", "contractExpiration", "player", "playerId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "contractExpiration": obj.get("contractExpiration"),
