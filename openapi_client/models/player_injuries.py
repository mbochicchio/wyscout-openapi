...
class PlayerInjuries(BaseModel):
    ...
    """ # noqa: E501
    injuries: Optional[List[TheInjuryObject]] = None
    player: Optional[Player] = None
    wy_id: Optional[StrictInt] = Field(default=None, alias="wyId")
    __properties: ClassVar[List[str]] = ["injuries", "player", "wyId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "injuries": [TheInjuryObject.from_dict(_item) for _item in obj["injuries"]] if obj.get("injuries") is not None else None,
