...
class InfractionDetails(BaseModel):
    """
    Available when event is foul, yellow_card or red_card
    """ # noqa: E501
    opponent: Optional[OpponentDetails1] = None
    red_card: Optional[StrictBool] = Field(default=None, description="If true this results in a red card", alias="redCard")
    type: Optional[StrictStr] = Field(default=None, description="<table><thead><tr><th>Possible type values</th></tr></thead><tbody><tr><td>hand_foul</td></tr><tr><td>regular_foul</td></tr><tr><td>violent_foul</td></tr><tr><td>out_of_play_foul</td></tr><tr><td>protest_foul</td></tr><tr><td>time_lost_foul</td></tr><tr><td>simulation_foul</td></tr><tr><td>late_card_foul</td></tr></tbody></table>")
    yellow_card: Optional[StrictBool] = Field(default=None, description="If true this results in a yellow card", alias="yellowCard")
    __properties: ClassVar[List[str]] = ["opponent", "redCard", "type", "yellowCard"]
