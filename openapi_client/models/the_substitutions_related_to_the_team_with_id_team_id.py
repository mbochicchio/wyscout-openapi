...
class TheSubstitutionsRelatedToTheTeamWithIDTeamId(BaseModel):
    """
    TheSubstitutionsRelatedToTheTeamWithIDTeamId
    """ # noqa: E501
    match_period: Optional[TheSubstitutionsRelatedToMatchPeriodMatchPeriod] = Field(default=None, alias="<matchPeriod>")
    __properties: ClassVar[List[str]] = ["&lt;matchPeriod&gt;"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of match_period
        if self.match_period:
            _dict['<matchPeriod>'] = self.match_period.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "<matchPeriod>": TheSubstitutionsRelatedToMatchPeriodMatchPeriod.from_dict(obj["<matchPeriod>"]) if obj.get("<matchPeriod>") is not None else None
        })
        return _obj
