...
class FormationsRelatedToThePeriodMatchPeriod(BaseModel):
    """
    FormationsRelatedToThePeriodMatchPeriod
    """ # noqa: E501
    startsec: Optional[FormationsRelatedToTheEventSecondStartsec] = Field(default=None, alias="<startsec>")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of startsec
        if self.startsec:
            _dict['<startsec>'] = self.startsec.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "<startsec>": FormationsRelatedToTheEventSecondStartsec.from_dict(obj["<startsec>"]) if obj.get("<startsec>") is not None else None
        })
        return _obj
