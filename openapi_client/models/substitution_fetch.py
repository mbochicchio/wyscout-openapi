...
class SubstitutionFetch(BaseModel):
    """
    Available with querystring param `fetch=substitutions`
    """ # noqa: E501
    team_id: Optional[TheSubstitutionsRelatedToTheTeamWithIDTeamId] = Field(default=None, alias="<teamId>")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "<teamId>": TheSubstitutionsRelatedToTheTeamWithIDTeamId.from_dict(obj["<teamId>"]) if obj.get("<teamId>") is not None else None
        })
        return _obj
