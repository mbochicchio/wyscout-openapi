...
class Offsets(BaseModel):
    ...
    """ # noqa: E501
    var_1_h: Optional[Offset] = Field(default=None, alias="1H")
    var_2_h: Optional[Offset] = Field(default=None, alias="2H")
    e1: Optional[Offset] = Field(default=None, alias="E1")
    e2: Optional[Offset] = Field(default=None, alias="E2")
    p: Optional[Offset] = Field(default=None, alias="P")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "1H": Offset.from_dict(obj["1H"]) if obj.get("1H") is not None else None,
            "2H": Offset.from_dict(obj["2H"]) if obj.get("2H") is not None else None,
            "E1": Offset.from_dict(obj["E1"]) if obj.get("E1") is not None else None,
            "E2": Offset.from_dict(obj["E2"]) if obj.get("E2") is not None else None,
            "P": Offset.from_dict(obj["P"]) if obj.get("P") is not None else None
        })
        return _obj
