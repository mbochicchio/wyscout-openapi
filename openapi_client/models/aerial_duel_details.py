...
class AerialDuelDetails(BaseModel):
    """
    Available when event is aerial duel
    """ # noqa: E501
    first_touch: Optional[StrictBool] = Field(default=None, description="Aerial duel won. An aerial duel is considered won in favor of the player who touches the ball first, no matter what happens next.", alias="firstTouch")
    height: Optional[StrictInt] = None
    opponent: Optional[OpponentDetails] = None
    related_duel_id: Optional[StrictInt] = Field(default=None, alias="relatedDuelId")
    __properties: ClassVar[List[str]] = ["firstTouch", "height", "opponent", "relatedDuelId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "opponent": OpponentDetails.from_dict(obj["opponent"]) if obj.get("opponent") is not None else None,
