...
class TheTransferObject1(BaseModel):
    """
    TheTransferObject1
    """ # noqa: E501
    active: Optional[StrictInt] = None
    announce_date: Optional[StrictStr] = Field(default=None, alias="announceDate")
    currency: Optional[StrictStr] = Field(default=None, description="<table><thead><tr><th>Currency</th></tr></thead><tbody><tr><td>USD</td></tr><tr><td>EUR</td></tr><tr><td>GBP</td></tr></tbody></table>")
    end_date: Optional[StrictStr] = Field(default=None, alias="endDate")
    from_team_id: Optional[StrictInt] = Field(default=None, alias="fromTeamId")
    from_team_name: Optional[StrictStr] = Field(default=None, alias="fromTeamName")
    ...
    teams_data: Optional[TheTeamsData] = Field(default=None, alias="teamsData")
    to_team_id: Optional[StrictInt] = Field(default=None, alias="toTeamId")
    to_team_name: Optional[StrictStr] = Field(default=None, alias="toTeamName")
    transfer_id: Optional[StrictInt] = Field(default=None, alias="transferId")
    type: Optional[StrictStr] = Field(default=None, description="<table><thead><tr><th>Transfer type</th></tr></thead><tbody><tr><td>Transfer</td></tr><tr><td>Free Transfer</td></tr><tr><td>Loan</td></tr><tr><td>Back from Loan</td></tr><tr><td>Free Agent</td></tr><tr><td>Player Swap</td></tr><tr><td>Trial</td></tr></tbody></table>")
    value: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["active", "announceDate", "currency", "endDate", "fromTeamId", "fromTeamName", "playerId", "startDate", "teamsData", "toTeamId", "toTeamName", "transferId", "type", "value"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['Transfer', 'Free Transfer', 'Loan', 'Back from Loan', 'Free Agent', 'Player Swap', 'Trial']):
            raise ValueError("must be one of enum values ('Transfer', 'Free Transfer', 'Loan', 'Back from Loan', 'Free Agent', 'Player Swap', 'Trial')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "announceDate": obj.get("announceDate"),
            "currency": obj.get("currency"),
            "endDate": obj.get("endDate"),
            "fromTeamId": obj.get("fromTeamId"),
            "fromTeamName": obj.get("fromTeamName"),
            "playerId": obj.get("playerId"),
            "startDate": obj.get("startDate"),
            "teamsData": TheTeamsData.from_dict(obj["teamsData"]) if obj.get("teamsData") is not None else None,
            "toTeamId": obj.get("toTeamId"),
            "toTeamName": obj.get("toTeamName"),
