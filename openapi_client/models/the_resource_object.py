...
class TheResourceObject(BaseModel):
    """
    TheResourceObject
    """ # noqa: E501
    resource_id: Optional[TheResourceObjectResourceId] = Field(default=None, alias="<resourceId>")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "<resourceId>": TheResourceObjectResourceId.from_dict(obj["<resourceId>"]) if obj.get("<resourceId>") is not None else None
        })
        return _obj
