...
class TheListOfMatchesInner(BaseModel):
    """
    ...
    status: Optional[StrictStr] = Field(default=None, description="<table><thead><tr><th>Status</th><th>Description</th></tr></thead><tbody><tr><td>Fixture</td><td>The match has yet to kick-off and a date and time has been defined</td></tr><tr><td>Played</td><td>The match has played</td></tr></tbody></table>")
    __properties: ClassVar[List[str]] = ["competitionId", "date", "dateutc", "gameweek", "label", "matchId", "roundId", "seasonId", "status"]
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(['Fixture', 'Played']):
            raise ValueError("must be one of enum values ('Fixture', 'Played')")
        return value
