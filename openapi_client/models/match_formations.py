...
class MatchFormations(BaseModel):
    """
    Retrieves information about a given match's formations
    """ # noqa: E501
    away: Optional[List[MatchFormation]] = None
    home: Optional[List[MatchFormation]] = None
    __properties: ClassVar[List[str]] = ["away", "home"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "away": [MatchFormation.from_dict(_item) for _item in obj["away"]] if obj.get("away") is not None else None,
            "home": [MatchFormation.from_dict(_item) for _item in obj["home"]] if obj.get("home") is not None else None
        })
        return _obj
