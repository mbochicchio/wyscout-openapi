...
class TeamsDetails(BaseModel):
    """
    Available with querystring param `details=teams`
    """ # noqa: E501
    from_team: Optional[OriginTeamDetails] = Field(default=None, alias="fromTeam")
    to_team: Optional[DestinationTeamDetails] = Field(default=None, alias="toTeam")
    __properties: ClassVar[List[str]] = ["fromTeam", "toTeam"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of from_team
        if self.from_team:
            _dict['fromTeam'] = self.from_team.to_dict()
        # override the default output from pydantic by calling `to_dict()` of to_team
        if self.to_team:
            _dict['toTeam'] = self.to_team.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "fromTeam": OriginTeamDetails.from_dict(obj["fromTeam"]) if obj.get("fromTeam") is not None else None,
            "toTeam": DestinationTeamDetails.from_dict(obj["toTeam"]) if obj.get("toTeam") is not None else None
        })
        return _obj
