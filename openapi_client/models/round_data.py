...
class RoundData(BaseModel):
    ...
    RoundData
    """ # noqa: E501
    groups: Optional[List[GroupStandings]] = None
    ...
    __properties: ClassVar[List[str]] = ["groups", "round", "roundId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "groups": [GroupStandings.from_dict(_item) for _item in obj["groups"]] if obj.get("groups") is not None else None,
