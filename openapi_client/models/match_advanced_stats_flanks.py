...
class MatchAdvancedStatsFlanks(BaseModel):
    """
    MatchAdvancedStatsFlanks
    """ # noqa: E501
    center_attacks: Optional[StrictInt] = Field(default=None, alias="centerAttacks")
    center_xg: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="centerXg")
    left_flank_attacks: Optional[StrictInt] = Field(default=None, alias="leftFlankAttacks")
    left_flank_xg: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="leftFlankXg")
    right_flank_attacks: Optional[StrictInt] = Field(default=None, alias="rightFlankAttacks")
    right_flank_xg: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="rightFlankXg")
    __properties: ClassVar[List[str]] = ["centerAttacks", "centerXg", "leftFlankAttacks", "leftFlankXg", "rightFlankAttacks", "rightFlankXg"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "centerAttacks": obj.get("centerAttacks"),
            "centerXg": obj.get("centerXg"),
            "leftFlankAttacks": obj.get("leftFlankAttacks"),
            "leftFlankXg": obj.get("leftFlankXg"),
            "rightFlankAttacks": obj.get("rightFlankAttacks"),
            "rightFlankXg": obj.get("rightFlankXg")
        })
        return _obj
