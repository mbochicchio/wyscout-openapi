...
class TeamMatchesMatchesInner(BaseModel):
    """
    ...
    status: Optional[StrictStr] = Field(default=None, description="<table><thead><tr><th>Status</th><th>Description</th></tr></thead><tbody><tr><td>Fixture</td><td>The match has yet to come</td></tr><tr><td>Played</td><td>The match is over</td></tr></tbody></table>")
