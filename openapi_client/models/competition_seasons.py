...
class CompetitionSeasons(BaseModel):
    ...
    seasons: Optional[List[TheListOfSeasonInner]] = None
    __properties: ClassVar[List[str]] = ["competition", "competitionId", "seasons"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "seasons": [TheListOfSeasonInner.from_dict(_item) for _item in obj["seasons"]] if obj.get("seasons") is not None else None
        })
        return _obj
