...
class TeamBenchedPlayersInner(BaseModel):
    """
    TeamBenchedPlayersInner
    """ # noqa: E501
    assists: Optional[StrictStr] = Field(default=None, description="Not available in Updated Objects endpoint")
    goals: Optional[StrictStr] = None
    own_goals: Optional[StrictStr] = Field(default=None, alias="ownGoals")
    player: Optional[Player] = Field(default=None, description="Available with param `details=players`")
    player_id: Optional[StrictInt] = Field(default=None, alias="playerId")
    red_cards: Optional[StrictStr] = Field(default=None, alias="redCards")
    shirt_number: Optional[StrictStr] = Field(default=None, alias="shirtNumber")
    yellow_cards: Optional[StrictStr] = Field(default=None, alias="yellowCards")
    __properties: ClassVar[List[str]] = ["assists", "goals", "ownGoals", "player", "playerId", "redCards", "shirtNumber", "yellowCards"]
