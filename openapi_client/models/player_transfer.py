...
class PlayerTransfer(BaseModel):
    ...
    """ # noqa: E501
    player: Optional[Player] = Field(default=None, description="Available with querystring param `fetch=player`")
    transfer: Optional[List[TheTransferObject1]] = Field(default=None, description="List of transfers related to a given player")
    wy_id: Optional[StrictInt] = Field(default=None, alias="wyId")
    __properties: ClassVar[List[str]] = ["player", "transfer", "wyId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "transfer": [TheTransferObject1.from_dict(_item) for _item in obj["transfer"]] if obj.get("transfer") is not None else None,
            "wyId": obj.get("wyId")
        })
        return _obj
