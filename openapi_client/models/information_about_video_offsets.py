...
class InformationAboutVideoOffsets(BaseModel):
    """
    InformationAboutVideoOffsets
    """ # noqa: E501
    var_1_h: Optional[Offset1] = Field(default=None, alias="1H")
    var_2_h: Optional[Offset2] = Field(default=None, alias="2H")
    e1: Optional[Offset3] = Field(default=None, alias="E1")
    e2: Optional[Offset4] = Field(default=None, alias="E2")
    p: Optional[Offset5] = Field(default=None, alias="P")
    __properties: ClassVar[List[str]] = ["1H", "2H", "E1", "E2", "P"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of var_1_h
        if self.var_1_h:
            _dict['1H'] = self.var_1_h.to_dict()
        # override the default output from pydantic by calling `to_dict()` of var_2_h
        if self.var_2_h:
            _dict['2H'] = self.var_2_h.to_dict()
        # override the default output from pydantic by calling `to_dict()` of e1
        if self.e1:
            _dict['E1'] = self.e1.to_dict()
        # override the default output from pydantic by calling `to_dict()` of e2
        if self.e2:
            _dict['E2'] = self.e2.to_dict()
        # override the default output from pydantic by calling `to_dict()` of p
        if self.p:
            _dict['P'] = self.p.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "1H": Offset1.from_dict(obj["1H"]) if obj.get("1H") is not None else None,
            "2H": Offset2.from_dict(obj["2H"]) if obj.get("2H") is not None else None,
            "E1": Offset3.from_dict(obj["E1"]) if obj.get("E1") is not None else None,
            "E2": Offset4.from_dict(obj["E2"]) if obj.get("E2") is not None else None,
            "P": Offset5.from_dict(obj["P"]) if obj.get("P") is not None else None
        })
        return _obj
