...
class TeamLineupBenchedSubstitutions(BaseModel):
    """
    Available if field `hasFormation=1`
    """ # noqa: E501
    bench: Optional[List[TeamBenchedPlayersInner]] = None
    lineup: Optional[List[TeamLineupInner]] = None
    substitutions: Optional[List[TeamSubstitutionsInner]] = None
    __properties: ClassVar[List[str]] = ["bench", "lineup", "substitutions"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.lineup:
            ...
            _dict['lineup'] = _items
        # override the default output from pydantic by calling `to_dict()` of each item in substitutions (list)
        _items = []
        if self.substitutions:
            for _item_substitutions in self.substitutions:
                if _item_substitutions:
                    _items.append(_item_substitutions.to_dict())
            _dict['substitutions'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "bench": [TeamBenchedPlayersInner.from_dict(_item) for _item in obj["bench"]] if obj.get("bench") is not None else None,
            "lineup": [TeamLineupInner.from_dict(_item) for _item in obj["lineup"]] if obj.get("lineup") is not None else None,
            "substitutions": [TeamSubstitutionsInner.from_dict(_item) for _item in obj["substitutions"]] if obj.get("substitutions") is not None else None
        })
        return _obj
