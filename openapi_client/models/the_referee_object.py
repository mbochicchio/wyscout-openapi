...
class TheRefereeObject(BaseModel):
    """
    TheRefereeObject
    """ # noqa: E501
    referee_id: Optional[StrictInt] = Field(default=None, alias="refereeId")
    role: Optional[StrictStr] = Field(default=None, description="<table><thead><tr><th>Role</th></tr></thead><tbody><tr><td>referee</td></tr><tr><td>firstAssistant</td></tr><tr><td>secondAssistant</td></tr><tr><td>fourthOfficial</td></tr></tbody></table>")
    __properties: ClassVar[List[str]] = ["refereeId", "role"]
