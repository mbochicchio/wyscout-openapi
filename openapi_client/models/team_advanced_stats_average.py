...
class TeamAdvancedStatsAverage(BaseModel):
    """
    ...
    gk_goal_kicks: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="A goal kick according to law 16 of the IFAB Laws of the Game, <i>Only Goalkeeper</i>", alias="gkGoalKicks")
    ...
    possession_percent: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="A metric quantifying how much a team is actually in possession of the ball. Available as pure time or as percentage of possession (compared to the opponent)", alias="possessionPercent")
    ...
    xg_shot_against: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="xgShotAgainst")
    ...
    __properties: ClassVar[List[str]] = ["accelerations", "aerialDuels", "assists", "attackingActions", "backPasses", "ballLosses", "ballRecoveries", "concededGoals", "corners", "crosses", "dangerousOpponentHalfRecoveries", "dangerousOwnHalfLosses", "defensiveActions", "defensiveDuels", "defensiveDuelsWon", "directFreeKicks", "directFreeKicksOnTarget", "directRedCards", "dribbleDistanceFromOpponentGoal", "dribbles", "duels", "duelsWon", "fieldAerialDuels", "fieldAerialDuelsWon", "forwardPasses", "fouls", "freeKicks", "freeKicksOnTarget", "gkAerialDuels", "gkAerialDuelsWon", "gkExits", "gkGoalKicks", "gkGoalKicksSuccess", "gkSaves", "gkSuccessfulExits", "goals", "headShots", "interceptions", "keyPasses", "lateralPasses", "linkupPlays", "longGoalKicks", "longPassLength", "longPasses", "looseBallDuels", "looseBallDuelsWon", "missedBalls", "newDefensiveDuelsWon", "newDuelsWon", "newOffensiveDuelsWon", "newSuccessfulDribbles", "offensiveDuels", "offensiveDuelsWon", "offsides", "opponentHalfRecoveries", "opponentOffsides", "ownHalfLosses", "passLength", "passes", "passesToFinalThird", "penalties", "possessionPercent", "progressiveRun", "receivedPass", "redCards", "shortGoalKicks", "shotAssists", "shotOnTargetAssists", "shots", "shotsAgainst", "smartPasses", "successfulAttackingActions", "successfulBackPasses", "successfulCrosses", "successfulDefensiveAction", "successfulDribbles", "successfulForwardPasses", "successfulKeyPasses", "successfulLateralPasses", "successfulLinkupPlays", "successfulLongPasses", "successfulPasses", "successfulPassesToFinalThird", "successfulPenalties", "successfulSmartPasses", "successfulThroughPasses", "successfulVerticalPasses", "throughPasses", "touchInBox", "verticalPasses", "xgShot", "xgShotAgainst", "yellowCards"]
