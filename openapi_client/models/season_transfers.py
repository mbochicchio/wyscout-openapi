...
class SeasonTransfers(BaseModel):
    """
    Retrieves all the transfer's information for the given season
    """ # noqa: E501
    transfer: Optional[List[TheTransferObject]] = None
    wy_id: Optional[StrictInt] = Field(default=None, alias="wyId")
    __properties: ClassVar[List[str]] = ["transfer", "wyId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "transfer": [TheTransferObject.from_dict(_item) for _item in obj["transfer"]] if obj.get("transfer") is not None else None,
            "wyId": obj.get("wyId")
        })
        return _obj
