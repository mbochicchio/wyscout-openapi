...
class TeamMatches(BaseModel):
    ...
    """ # noqa: E501
    matches: Optional[List[TeamMatchesMatchesInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "matches": [TeamMatchesMatchesInner.from_dict(_item) for _item in obj["matches"]] if obj.get("matches") is not None else None,
