...
class PlayerMatchAdvancedStats(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["average", "competition", "competitionId", "match", "matchId", "percent", "player", "playerId", "positions", "round", "roundId", "season", "seasonId", "total"]
