...
class RefereesApi:
    ...
    @validate_call
    def referees_wy_id_get(
        self,
        wy_id: StrictStr,
        image_data_url: Annotated[Optional[StrictStr], Field(description="If true adds the base64 encoded referee image to the payload")] = None,
        ...
        :type wy_id: str
        :param image_data_url: If true adds the base64 encoded referee image to the payload
        ...
        _param = self._referees_wy_id_get_serialize(
            wy_id=wy_id,
    ...
    @validate_call
    def referees_wy_id_get_with_http_info(
        self,
        wy_id: StrictStr,
        image_data_url: Annotated[Optional[StrictStr], Field(description="If true adds the base64 encoded referee image to the payload")] = None,
        authorization: Optional[StrictStr] = None,
    ...
    @validate_call
    def referees_wy_id_get_without_preload_content(
        self,
        wy_id: StrictStr,
        image_data_url: Annotated[Optional[StrictStr], Field(description="If true adds the base64 encoded referee image to the payload")] = None,
        authorization: Optional[StrictStr] = None,
    ...
    def _referees_wy_id_get_serialize(
        self,
        wy_id,
        image_data_url,
        authorization,
        ...
        if image_data_url is not None:
            ...
            _query_params.append(('imageDataURL', image_data_url))
