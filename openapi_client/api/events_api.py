...
class EventsApi:
    ...
    @validate_call
    def matches_wy_id_events_get(
        self,
        wy_id: Annotated[StrictStr, Field(description="Relevant content id")],
        fetch: Annotated[Optional[StrictStr], Field(description="List of related objects to be fetched, separated by comma: `teams`, `players`, `match`, `coaches`, `referees`, `formations`, `substitutions`")] = None,
        details: Annotated[Optional[StrictStr], Field(description="List of related objects to be detailed, separated by comma: `tag`")] = None,
        exclude: Annotated[Optional[StrictStr], Field(description="List of objects to exclude from API output, separated by comma: `possessions`, `names`, `positions`, `formations`")] = None,
        ...
        :type wy_id: str
        :param fetch: List of related objects to be fetched, separated by comma: `teams`, `players`, `match`, `coaches`, `referees`, `formations`, `substitutions`
        :type fetch: str
        :param details: List of related objects to be detailed, separated by comma: `tag`
        :type details: str
        :param exclude: List of objects to exclude from API output, separated by comma: `possessions`, `names`, `positions`, `formations`
        :type exclude: str
        :param authorization:
        ...
        _param = self._matches_wy_id_events_get_serialize(
            wy_id=wy_id,
            fetch=fetch,
            details=details,
            exclude=exclude,
    ...
    @validate_call
    def matches_wy_id_events_get_with_http_info(
        self,
        wy_id: Annotated[StrictStr, Field(description="Relevant content id")],
        fetch: Annotated[Optional[StrictStr], Field(description="List of related objects to be fetched, separated by comma: `teams`, `players`, `match`, `coaches`, `referees`, `formations`, `substitutions`")] = None,
        details: Annotated[Optional[StrictStr], Field(description="List of related objects to be detailed, separated by comma: `tag`")] = None,
    ...
    @validate_call
    def matches_wy_id_events_get_without_preload_content(
        self,
        wy_id: Annotated[StrictStr, Field(description="Relevant content id")],
        fetch: Annotated[Optional[StrictStr], Field(description="List of related objects to be fetched, separated by comma: `teams`, `players`, `match`, `coaches`, `referees`, `formations`, `substitutions`")] = None,
        details: Annotated[Optional[StrictStr], Field(description="List of related objects to be detailed, separated by comma: `tag`")] = None,
    ...
    def _matches_wy_id_events_get_serialize(
        self,
        wy_id,
        fetch,
        details,
