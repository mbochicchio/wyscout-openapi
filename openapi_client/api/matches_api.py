...
class MatchesApi:
    ...
    @validate_call
    def matches_wy_id_directions_get(
        self,
        ...
        _param = self._matches_wy_id_directions_get_serialize(
            wy_id=wy_id,
    ...
    @validate_call
    def matches_wy_id_directions_get_with_http_info(
        self,
        wy_id: Annotated[StrictStr, Field(description="Relevant content id")],
        authorization: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def matches_wy_id_directions_get_without_preload_content(
        self,
        wy_id: Annotated[StrictStr, Field(description="Relevant content id")],
        authorization: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    def _matches_wy_id_directions_get_serialize(
        self,
        wy_id,
        authorization,
        _request_auth,
    ...
    @validate_call
    def matches_wy_id_formations_get(
        self,
        wy_id: Annotated[StrictStr, Field(description="Relevant content id")],
        details: Annotated[Optional[StrictStr], Field(description="List of related objects to be detailed, separated by comma: `teams`, `players`")] = None,
        authorization: Optional[StrictStr] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param wy_id: Relevant content id (required)
        :type wy_id: str
        :param details: List of related objects to be detailed, separated by comma: `teams`, `players`
        :type details: str
        :param authorization:
        :type authorization: str
        :param _request_timeout: timeout setting for this request. If one
        ...
        _param = self._matches_wy_id_formations_get_serialize(
            wy_id=wy_id,
            details=details,
            authorization=authorization,
            _request_auth=_request_auth,
    ...
    @validate_call
    def matches_wy_id_formations_get_with_http_info(
        self,
        wy_id: Annotated[StrictStr, Field(description="Relevant content id")],
        details: Annotated[Optional[StrictStr], Field(description="List of related objects to be detailed, separated by comma: `teams`, `players`")] = None,
        authorization: Optional[StrictStr] = None,
    ...
    @validate_call
    def matches_wy_id_formations_get_without_preload_content(
        self,
        wy_id: Annotated[StrictStr, Field(description="Relevant content id")],
        details: Annotated[Optional[StrictStr], Field(description="List of related objects to be detailed, separated by comma: `teams`, `players`")] = None,
        authorization: Optional[StrictStr] = None,
    ...
    def _matches_wy_id_formations_get_serialize(
        self,
        wy_id,
        details,
        authorization,
    ...
    @validate_call
    def matches_wy_id_get(
        self,
        wy_id: Annotated[StrictStr, Field(description="Relevant content id")],
        use_sides: Annotated[Optional[StrictStr], Field(description="Flag to change label (teamId –> home or teamId –> away)")] = None,
        details: Annotated[Optional[StrictStr], Field(description="List of related objects to be detailed, separated by comma: `coaches`, `players`, `teams`, `competition`, `round`, `season`")] = None,
        authorization: Optional[StrictStr] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :type use_sides: str
        :param details: List of related objects to be detailed, separated by comma: `coaches`, `players`, `teams`, `competition`, `round`, `season`
        :type details: str
        :param authorization:
        :type authorization: str
        :param _request_timeout: timeout setting for this request. If one
        ...
        _param = self._matches_wy_id_get_serialize(
            wy_id=wy_id,
            use_sides=use_sides,
            details=details,
            authorization=authorization,
    ...
    @validate_call
    def matches_wy_id_get_with_http_info(
        self,
        wy_id: Annotated[StrictStr, Field(description="Relevant content id")],
        use_sides: Annotated[Optional[StrictStr], Field(description="Flag to change label (teamId –> home or teamId –> away)")] = None,
        details: Annotated[Optional[StrictStr], Field(description="List of related objects to be detailed, separated by comma: `coaches`, `players`, `teams`, `competition`, `round`, `season`")] = None,
    ...
    @validate_call
    def matches_wy_id_get_without_preload_content(
        self,
        wy_id: Annotated[StrictStr, Field(description="Relevant content id")],
        use_sides: Annotated[Optional[StrictStr], Field(description="Flag to change label (teamId –> home or teamId –> away)")] = None,
        details: Annotated[Optional[StrictStr], Field(description="List of related objects to be detailed, separated by comma: `coaches`, `players`, `teams`, `competition`, `round`, `season`")] = None,
    ...
    def _matches_wy_id_get_serialize(
        self,
        wy_id,
        use_sides,
        details,
