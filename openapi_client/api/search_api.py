...
class SearchApi:
    ...
    def search_get(
        self,
        query: Annotated[StrictStr, Field(description="The string to be matched with the resource's name")],
        obj_type: Annotated[StrictStr, Field(description="Object to be retrieved (only the first type is considered): `competition`, `team`, `player`, `referee`")],
        gender: Annotated[Optional[StrictStr], Field(description="Object to be retrieved (only the first type is considered): `men`, `women`")] = None,
        ...
        :param query: The string to be matched with the resource's name (required)
        :type query: str
        :param obj_type: Object to be retrieved (only the first type is considered): `competition`, `team`, `player`, `referee` (required)
        :type obj_type: str
        :param gender: Object to be retrieved (only the first type is considered): `men`, `women`
        :type gender: str
        :param authorization:
    ...
    def _search_get_serialize(
        ...
        if obj_type is not None:
            ...
            _query_params.append(('objType', obj_type))
