...
class TestPlayersListInner(unittest.TestCase):
    """PlayersListInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PlayersListInner:
        """Test PlayersListInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PlayersListInner`
        """
        model = PlayersListInner()
        if include_optional:
            return PlayersListInner(
