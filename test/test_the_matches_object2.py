...
class TestTheMatchesObject2(unittest.TestCase):
    """TheMatchesObject2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TheMatchesObject2:
        """Test TheMatchesObject2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TheMatchesObject2`
        """
        model = TheMatchesObject2()
        if include_optional:
            return TheMatchesObject2(
                competition_id = 56,
                var_date = '',
                dateutc = '',
                gameweek = 56,
    ...
    def testTheMatchesObject2(self):
        """Test TheMatchesObject2"""
