...
class TestAerialDuelDetails(unittest.TestCase):
    """AerialDuelDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AerialDuelDetails:
        """Test AerialDuelDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AerialDuelDetails`
        """
        model = AerialDuelDetails()
        if include_optional:
            return AerialDuelDetails(
                first_touch = True,
                height = 56,
    ...
    def testAerialDuelDetails(self):
        """Test AerialDuelDetails"""
