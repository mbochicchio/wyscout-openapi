...
class TestMatchAdvancedStatsPossession(unittest.TestCase):
    """MatchAdvancedStatsPossession unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatchAdvancedStatsPossession:
        """Test MatchAdvancedStatsPossession
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatchAdvancedStatsPossession`
        """
        model = MatchAdvancedStatsPossession()
        if include_optional:
            return MatchAdvancedStatsPossession(
    ...
    def testMatchAdvancedStatsPossession(self):
        """Test MatchAdvancedStatsPossession"""
