...
class TestCompetitionMatches(unittest.TestCase):
    """CompetitionMatches unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CompetitionMatches:
        """Test CompetitionMatches
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CompetitionMatches`
        """
        model = CompetitionMatches()
        if include_optional:
            return CompetitionMatches(
                ...
                matches = [
                    openapi_client.models.the_list_of_matches_inner.The_list_of_matches_inner(
                        competition_id = 56, 
                        date = '', 
                        dateutc = '', 
                        gameweek = 56, 
    ...
    def testCompetitionMatches(self):
        """Test CompetitionMatches"""
