...
class TestPositionOfThePlayer(unittest.TestCase):
    """PositionOfThePlayer unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PositionOfThePlayer:
        """Test PositionOfThePlayer
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PositionOfThePlayer`
        """
        model = PositionOfThePlayer()
        if include_optional:
            return PositionOfThePlayer(
                code = '',
                name = ''
            )
        else:
    ...
    def testPositionOfThePlayer(self):
        """Test PositionOfThePlayer"""
