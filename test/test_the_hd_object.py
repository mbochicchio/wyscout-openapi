...
class TestTheHdObject(unittest.TestCase):
    """TheHdObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TheHdObject:
        """Test TheHdObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TheHdObject`
        """
        model = TheHdObject()
        if include_optional:
            return TheHdObject(
