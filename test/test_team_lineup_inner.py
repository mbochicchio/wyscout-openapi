...
class TestTeamLineupInner(unittest.TestCase):
    """TeamLineupInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TeamLineupInner:
        """Test TeamLineupInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TeamLineupInner`
        """
        model = TeamLineupInner()
        if include_optional:
            return TeamLineupInner(
                assists = '',
                goals = '',
                own_goals = '',
