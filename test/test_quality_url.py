...
class TestQualityUrl(unittest.TestCase):
    """QualityUrl unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QualityUrl:
        """Test QualityUrl
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QualityUrl`
        """
        model = QualityUrl()
        if include_optional:
            return QualityUrl(
