...
class TestOffset1(unittest.TestCase):
    """Offset1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Offset1:
        """Test Offset1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Offset1`
        """
        model = Offset1()
        if include_optional:
            return Offset1(
