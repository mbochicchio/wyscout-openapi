...
class TestTeamFixtures(unittest.TestCase):
    """TeamFixtures unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TeamFixtures:
        """Test TeamFixtures
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TeamFixtures`
        """
        model = TeamFixtures()
        if include_optional:
            return TeamFixtures(
