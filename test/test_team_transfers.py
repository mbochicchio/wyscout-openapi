...
class TestTeamTransfers(unittest.TestCase):
    """TeamTransfers unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TeamTransfers:
        """Test TeamTransfers
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TeamTransfers`
        """
        model = TeamTransfers()
        if include_optional:
