...
class TestMatchAdvancedStatsOpenPlay(unittest.TestCase):
    """MatchAdvancedStatsOpenPlay unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatchAdvancedStatsOpenPlay:
        """Test MatchAdvancedStatsOpenPlay
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatchAdvancedStatsOpenPlay`
        """
        model = MatchAdvancedStatsOpenPlay()
        if include_optional:
            return MatchAdvancedStatsOpenPlay(
                long = 56,
                medium = 56,
                short = 56,
                total = 56,
    ...
    def testMatchAdvancedStatsOpenPlay(self):
        """Test MatchAdvancedStatsOpenPlay"""
