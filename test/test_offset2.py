...
class TestOffset2(unittest.TestCase):
    """Offset2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Offset2:
        """Test Offset2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Offset2`
        """
        model = Offset2()
        if include_optional:
            return Offset2(
