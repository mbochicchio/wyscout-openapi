...
class TestCompetitionPlayers(unittest.TestCase):
    """CompetitionPlayers unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CompetitionPlayers:
        """Test CompetitionPlayers
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CompetitionPlayers`
        """
        model = CompetitionPlayers()
        if include_optional:
    ...
    def testCompetitionPlayers(self):
        """Test CompetitionPlayers"""
