...
class TestPlayerAdvancedStats(unittest.TestCase):
    """PlayerAdvancedStats unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PlayerAdvancedStats:
        """Test PlayerAdvancedStats
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PlayerAdvancedStats`
        """
    ...
    def testPlayerAdvancedStats(self):
        """Test PlayerAdvancedStats"""
