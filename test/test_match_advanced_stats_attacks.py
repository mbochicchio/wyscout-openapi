...
class TestMatchAdvancedStatsAttacks(unittest.TestCase):
    """MatchAdvancedStatsAttacks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatchAdvancedStatsAttacks:
        """Test MatchAdvancedStatsAttacks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatchAdvancedStatsAttacks`
        """
        model = MatchAdvancedStatsAttacks()
        if include_optional:
            return MatchAdvancedStatsAttacks(
                corners = 56,
    ...
    def testMatchAdvancedStatsAttacks(self):
        """Test MatchAdvancedStatsAttacks"""
