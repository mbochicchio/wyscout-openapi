...
class TestRefereesApi(unittest.TestCase):
    """RefereesApi unit test stubs"""

    def setUp(self) -> None:
        self.api = RefereesApi()

    def tearDown(self) -> None:
        pass

    def test_referees_wy_id_get(self) -> None:
        """Test case for referees_wy_id_get
