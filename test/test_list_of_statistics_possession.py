...
class TestListOfStatisticsPossession(unittest.TestCase):
    """ListOfStatisticsPossession unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListOfStatisticsPossession:
        """Test ListOfStatisticsPossession
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListOfStatisticsPossession`
        """
        model = ListOfStatisticsPossession()
        if include_optional:
            return ListOfStatisticsPossession(
    ...
    def testListOfStatisticsPossession(self):
        """Test ListOfStatisticsPossession"""
