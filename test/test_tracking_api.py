...
class TestTrackingApi(unittest.TestCase):
    ...
    def test_matches_wy_id_fulltracking_get(self) -> None:
        """Test case for matches_wy_id_fulltracking_get

        Broadcast tracking
        """
        pass

    def test_matches_wy_id_physicaldata_get(self) -> None:
        """Test case for matches_wy_id_physicaldata_get
