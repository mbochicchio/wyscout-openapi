...
class TestOffset4(unittest.TestCase):
    """Offset4 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Offset4:
        """Test Offset4
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Offset4`
        """
        model = Offset4()
        if include_optional:
            return Offset4(
