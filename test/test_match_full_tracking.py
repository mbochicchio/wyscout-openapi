...
class TestMatchFullTracking(unittest.TestCase):
    """MatchFullTracking unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatchFullTracking:
        """Test MatchFullTracking
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatchFullTracking`
        """
        model = MatchFullTracking()
        if include_optional:
            return MatchFullTracking(
                tracking_download_url = '',
                wy_id = 56
            )
        else:
            return MatchFullTracking(
    ...
    def testMatchFullTracking(self):
        """Test MatchFullTracking"""
