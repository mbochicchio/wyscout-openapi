...
class TestTheInjuryObject(unittest.TestCase):
    """TheInjuryObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TheInjuryObject:
        """Test TheInjuryObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TheInjuryObject`
        """
        model = TheInjuryObject()
        if include_optional:
            return TheInjuryObject(
                description = '',
                from_date = '',
                games_missed = 56,
                id = 56,
