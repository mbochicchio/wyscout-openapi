...
class TestOpponentDetails(unittest.TestCase):
    """OpponentDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OpponentDetails:
        """Test OpponentDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OpponentDetails`
        """
        model = OpponentDetails()
        if include_optional:
