...
class TestPossessionStartLocation(unittest.TestCase):
    """PossessionStartLocation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PossessionStartLocation:
        """Test PossessionStartLocation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PossessionStartLocation`
        """
        model = PossessionStartLocation()
        if include_optional:
            return PossessionStartLocation(
                x = 56,
                y = 56
            )
        else:
    ...
    def testPossessionStartLocation(self):
        """Test PossessionStartLocation"""
