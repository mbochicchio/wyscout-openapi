...
class TestSeasonStandings(unittest.TestCase):
    """SeasonStandings unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SeasonStandings:
        """Test SeasonStandings
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SeasonStandings`
        """
        ...
        if include_optional:
            return SeasonStandings(
                ...
                season_id = 56,
                teams = [
                    openapi_client.models.the_team_object.The team object(
                        group_name = '', 
                        team = null, 
                        team_id = 56, 
                        total_draws = 56, 
                        total_goals_against = 56, 
                        total_goals_for = 56, 
                        total_losses = 56, 
                        total_played = 56, 
                        total_points = 56, 
