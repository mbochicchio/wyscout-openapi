...
class TestTheAppliedFiltersSchema(unittest.TestCase):
    """TheAppliedFiltersSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TheAppliedFiltersSchema:
        """Test TheAppliedFiltersSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TheAppliedFiltersSchema`
        """
        model = TheAppliedFiltersSchema()
        if include_optional:
            return TheAppliedFiltersSchema(
                advsearch = [
                    ''
                    ],
                fetch = [
    ...
    def testTheAppliedFiltersSchema(self):
        """Test TheAppliedFiltersSchema"""
