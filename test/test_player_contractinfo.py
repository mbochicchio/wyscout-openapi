...
class TestPlayerContractinfo(unittest.TestCase):
    """PlayerContractinfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PlayerContractinfo:
        """Test PlayerContractinfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PlayerContractinfo`
        """
        model = PlayerContractinfo()
        if include_optional:
            return PlayerContractinfo(
                agencies = [
                    ''
                    ],
                contract_expiration = '',
    ...
    def testPlayerContractinfo(self):
        """Test PlayerContractinfo"""
