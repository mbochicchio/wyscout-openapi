...
class TestMainRole(unittest.TestCase):
    """MainRole unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MainRole:
        """Test MainRole
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MainRole`
        """
        model = MainRole()
        if include_optional:
            return MainRole(
