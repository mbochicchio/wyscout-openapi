...
class TestSeasonTeams(unittest.TestCase):
    """SeasonTeams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SeasonTeams:
        """Test SeasonTeams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SeasonTeams`
        """
        model = SeasonTeams()
        if include_optional:
            return SeasonTeams(
