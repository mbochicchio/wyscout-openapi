...
class TestTheTransferObject(unittest.TestCase):
    """TheTransferObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TheTransferObject:
        """Test TheTransferObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TheTransferObject`
        """
        model = TheTransferObject()
        if include_optional:
            return TheTransferObject(
                active = 56,
                announce_date = '',
                currency = 'USD',
                end_date = '',
                ...
                player_id = 56,
                start_date = '',
                teams_data = openapi_client.models.teams_details.teams details(
    ...
    def testTheTransferObject(self):
        """Test TheTransferObject"""
