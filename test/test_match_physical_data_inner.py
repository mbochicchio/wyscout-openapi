...
class TestMatchPhysicalDataInner(unittest.TestCase):
    """MatchPhysicalDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatchPhysicalDataInner:
        """Test MatchPhysicalDataInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatchPhysicalDataInner`
        """
        model = MatchPhysicalDataInner()
        if include_optional:
            return MatchPhysicalDataInner(
                game_id = '',
                players = [
                    openapi_client.models.match_physical_data_inner_players_inner.MatchPhysicalData_inner_players_inner(
                        id = '', 
                        metrics = [
                            openapi_client.models.match_physical_data_inner_players_inner_metrics_inner.MatchPhysicalData_inner_players_inner_metrics_inner(
                                name = '', 
                                values = [
                                    openapi_client.models.match_physical_data_inner_players_inner_metrics_inner_values_inner.MatchPhysicalData_inner_players_inner_metrics_inner_values_inner(
                                        phase = '', 
                                        value = 1.337, )
                                    ], )
                            ], 
    ...
    def testMatchPhysicalDataInner(self):
        """Test MatchPhysicalDataInner"""
