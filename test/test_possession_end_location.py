...
class TestPossessionEndLocation(unittest.TestCase):
    """PossessionEndLocation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PossessionEndLocation:
        """Test PossessionEndLocation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PossessionEndLocation`
        """
        model = PossessionEndLocation()
        if include_optional:
            return PossessionEndLocation(
                x = 56,
                y = 56
            )
        else:
    ...
    def testPossessionEndLocation(self):
        """Test PossessionEndLocation"""
