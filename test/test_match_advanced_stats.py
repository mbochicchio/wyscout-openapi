...
class TestMatchAdvancedStats(unittest.TestCase):
    """MatchAdvancedStats unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatchAdvancedStats:
        """Test MatchAdvancedStats
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatchAdvancedStats`
        """
        model = MatchAdvancedStats()
        if include_optional:
            return MatchAdvancedStats(
                attacks = openapi_client.models.list_of_statistics,_attacks.List of statistics, attacks(
                    <team_id> = openapi_client.models.match_advanced_stats_attacks.Match Advanced Stats Attacks(
                        corners = 56, 
                        corners_with_shot = 56, 
                        counter_attacks = 56, 
                        free_kicks = 56, 
                        free_kicks_with_shot = 56, 
                        positional_attack = 56, 
                        positional_with_shots = 56, 
                        total = 56, 
                        with_shots = 56, ), ),
                defence = openapi_client.models.list_of_statistics,_defense.List of statistics, defense(
                    <team_id> = openapi_client.models.match_advanced_stats_defence.Match Advanced Stats Defence(
                        clearances = 56, 
                        interceptions = 56, 
                        ppda = 1.337, 
                        tackles = 56, ), ),
                duels = openapi_client.models.list_of_statistics,_duels.List of statistics, duels(
                    <team_id> = openapi_client.models.match_advanced_stats_duels.Match Advanced Stats Duels(
                        aerial_duels = 56, 
                        aerial_duels_successful = 56, 
                        challenge_intensity = 1.337, 
                        defensive_duels = 56, 
                        defensive_duels_successful = 56, 
                        dribbles = 56, 
                        dribbles_successful = 56, 
                        duels = 56, 
                        duels_successful = 56, 
                        ground_duels = 56, 
                        ground_duels_successful = 56, 
                        loose_ball_duels = 56, 
                        loose_ball_duels_successful = 56, 
                        offensive_duels = 56, 
                        offensive_duels_successful = 56, ), ),
                flanks = openapi_client.models.list_of_statistics,_flanks.List of statistics, flanks(
                    <team_id> = openapi_client.models.match_advanced_stats_flanks.Match Advanced Stats Flanks(
                        center_attacks = 56, 
                        center_xg = 1.337, 
                        left_flank_attacks = 56, 
                        left_flank_xg = 1.337, 
                        right_flank_attacks = 56, 
                        right_flank_xg = 1.337, ), ),
                general = openapi_client.models.list_of_statistics,_general.List of statistics, general(
                    <team_id> = openapi_client.models.match_advanced_stats_general.Match Advanced Stats General(
                        avg_distance = 1.337, 
                        corners = 56, 
                        dribbles = 56, 
                        fouls = 56, 
                        ...
                        shots_blocked = 56, 
                        shots_from_box = 56, 
                        shots_from_box_on_target = 56, 
                        shots_from_danger_zone = 56, 
                        shots_on_post = 56, 
                        shots_on_target = 56, 
                        shots_outside_box = 56, 
                        shots_outside_box_on_target = 56, 
                        shots_wide = 56, 
                        total_throw_ins = 56, 
                        touches_in_box = 56, 
                        xg = 1.337, 
                ...
                match_id = 56,
                open_play = openapi_client.models.list_of_statistics,_open_play.List of statistics, open play(
                    <team_id> = openapi_client.models.match_advanced_stats_open_play.Match Advanced Stats Open Play(
                        long = 56, 
                        medium = 56, 
                        short = 56, 
                        total = 56, 
                        very_long = 56, ), ),
                passes = openapi_client.models.list_of_statistics,_passes.List of statistics, passes(
                ...
                possession = openapi_client.models.list_of_statistics,_possession.List of statistics, possession(
                    <team_id> = openapi_client.models.match_advanced_stats_possession.Match Advanced Stats Possession(
                        avg_possession_duration = '', 
                        minutes_of_possession1_15 = '', 
                        minutes_of_possession106_120 = '', 
                        minutes_of_possession16_30 = '', 
                        minutes_of_possession31_45 = '', 
                        minutes_of_possession46_60 = '', 
                        minutes_of_possession61_75 = '', 
                        minutes_of_possession76_90 = '', 
                        minutes_of_possession91_105 = '', 
                        possession1_15 = 56, 
                        possession106_120 = 56, 
                        possession16_30 = 56, 
                        possession31_45 = 56, 
                        possession46_60 = 56, 
                        possession61_75 = 56, 
                        possession76_90 = 56, 
                        possession91_105 = 56, 
                        possession_number = 56, 
                        possession_percent = 56, 
                        pure_possession_time = '', 
                        reaching_opponent_box = 56, 
                        reaching_opponent_half = 56, ), 
                    dead_time = '', 
                    total_time = '', ),
                teams = openapi_client.models.teams_details.Teams details(
                ...
                transitions = openapi_client.models.list_of_statistics,_transitions.List of statistics, transitions(
                    <team_id> = openapi_client.models.match_advanced_stats_transitions.Match Advanced Stats Transitions(
                        losses_high = 56, 
                        losses_low = 56, 
                        losses_medium = 56, 
                        losses_total = 56, 
    ...
    def testMatchAdvancedStats(self):
        """Test MatchAdvancedStats"""
