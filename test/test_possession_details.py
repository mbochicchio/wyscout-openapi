...
class TestPossessionDetails(unittest.TestCase):
    """PossessionDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PossessionDetails:
        """Test PossessionDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PossessionDetails`
        """
        model = PossessionDetails()
        if include_optional:
            return PossessionDetails(
                attack = openapi_client.models.attack_details.Attack details(
                    ...
                    xg = 56, ),
                duration = '',
                end_location = openapi_client.models.possession_end_location.Possession end location(
                    x = 56, 
                    y = 56, ),
                event_index = 56,
                events_number = 56,
    ...
    def testPossessionDetails(self):
        """Test PossessionDetails"""
