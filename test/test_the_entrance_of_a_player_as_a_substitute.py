...
class TestTheEntranceOfAPlayerAsASubstitute(unittest.TestCase):
    """TheEntranceOfAPlayerAsASubstitute unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TheEntranceOfAPlayerAsASubstitute:
        """Test TheEntranceOfAPlayerAsASubstitute
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TheEntranceOfAPlayerAsASubstitute`
        """
        model = TheEntranceOfAPlayerAsASubstitute()
        if include_optional:
            return TheEntranceOfAPlayerAsASubstitute(
                player_id = 56
            )
        else:
            return TheEntranceOfAPlayerAsASubstitute(
    ...
    def testTheEntranceOfAPlayerAsASubstitute(self):
        """Test TheEntranceOfAPlayerAsASubstitute"""
