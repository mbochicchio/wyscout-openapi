...
class TestListOfStatisticsDefense(unittest.TestCase):
    """ListOfStatisticsDefense unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListOfStatisticsDefense:
        """Test ListOfStatisticsDefense
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListOfStatisticsDefense`
        """
        model = ListOfStatisticsDefense()
        if include_optional:
            return ListOfStatisticsDefense(
    ...
    def testListOfStatisticsDefense(self):
        """Test ListOfStatisticsDefense"""
