...
class TestMatchDirections(unittest.TestCase):
    """MatchDirections unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatchDirections:
        """Test MatchDirections
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatchDirections`
        """
        model = MatchDirections()
        if include_optional:
            return MatchDirections(
                var_1_h = openapi_client.models.match_directions_object.Match Directions object(
                    left_to_right_team_id = 56, 
                    right_to_left_team_id = 56, ),
                var_2_h = openapi_client.models.match_directions_object.Match Directions object(
                    left_to_right_team_id = 56, 
                    right_to_left_team_id = 56, ),
                e1 = openapi_client.models.match_directions_object.Match Directions object(
                    left_to_right_team_id = 56, 
                    right_to_left_team_id = 56, ),
                e2 = openapi_client.models.match_directions_object.Match Directions object(
                    left_to_right_team_id = 56, 
                    right_to_left_team_id = 56, )
            )
        else:
