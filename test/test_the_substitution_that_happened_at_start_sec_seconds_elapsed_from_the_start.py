...
class TestTheSubstitutionThatHappenedAtStartSecSecondsElapsedFromTheStart(unittest.TestCase):
    """TheSubstitutionThatHappenedAtStartSecSecondsElapsedFromTheStart unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TheSubstitutionThatHappenedAtStartSecSecondsElapsedFromTheStart:
        """Test TheSubstitutionThatHappenedAtStartSecSecondsElapsedFromTheStart
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TheSubstitutionThatHappenedAtStartSecSecondsElapsedFromTheStart`
        """
        model = TheSubstitutionThatHappenedAtStartSecSecondsElapsedFromTheStart()
        if include_optional:
            return TheSubstitutionThatHappenedAtStartSecSecondsElapsedFromTheStart(
                var_in = [
    ...
    def testTheSubstitutionThatHappenedAtStartSecSecondsElapsedFromTheStart(self):
        """Test TheSubstitutionThatHappenedAtStartSecSecondsElapsedFromTheStart"""
