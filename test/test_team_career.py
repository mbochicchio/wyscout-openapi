...
class TestTeamCareer(unittest.TestCase):
    """TeamCareer unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TeamCareer:
        """Test TeamCareer
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TeamCareer`
        """
        model = TeamCareer()
        if include_optional:
            return TeamCareer(
