...
class TestCompetitions(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Competitions:
        """Test Competitions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Competitions`
        """
        model = Competitions()
        if include_optional:
            return Competitions(
                competitions = [
                    {"area":{"alpha2code":"JO","alpha3code":"JOR","id":400,"name":"Jordan"},"category":"default","divisionLevel":0,"format":"Domestic league","gender":"male","gsmId":1195,"name":"1st Division","type":"club","wyId":1495}
                    ]
            )
        else:
            return Competitions(
