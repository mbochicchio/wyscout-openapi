...
class TestListOfStatisticsDuels(unittest.TestCase):
    """ListOfStatisticsDuels unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListOfStatisticsDuels:
        """Test ListOfStatisticsDuels
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListOfStatisticsDuels`
        """
        model = ListOfStatisticsDuels()
        if include_optional:
            return ListOfStatisticsDuels(
    ...
    def testListOfStatisticsDuels(self):
        """Test ListOfStatisticsDuels"""
