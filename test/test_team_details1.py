...
class TestTeamDetails1(unittest.TestCase):
    """TeamDetails1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TeamDetails1:
        """Test TeamDetails1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TeamDetails1`
        """
        model = TeamDetails1()
        if include_optional:
            return TeamDetails1(
