...
class TestTeamsDetails(unittest.TestCase):
    """TeamsDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TeamsDetails:
        """Test TeamsDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TeamsDetails`
        """
        model = TeamsDetails()
        if include_optional:
            return TeamsDetails(
