...
class TestSeasonPlayers(unittest.TestCase):
    """SeasonPlayers unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SeasonPlayers:
        """Test SeasonPlayers
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SeasonPlayers`
        """
        model = SeasonPlayers()
        if include_optional:
