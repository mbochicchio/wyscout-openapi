...
class TestMatchPhysicalDataInnerPlayersInnerMetricsInner(unittest.TestCase):
    """MatchPhysicalDataInnerPlayersInnerMetricsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatchPhysicalDataInnerPlayersInnerMetricsInner:
        """Test MatchPhysicalDataInnerPlayersInnerMetricsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatchPhysicalDataInnerPlayersInnerMetricsInner`
        """
        model = MatchPhysicalDataInnerPlayersInnerMetricsInner()
        if include_optional:
            return MatchPhysicalDataInnerPlayersInnerMetricsInner(
                name = '',
                values = [
    ...
    def testMatchPhysicalDataInnerPlayersInnerMetricsInner(self):
        """Test MatchPhysicalDataInnerPlayersInnerMetricsInner"""
