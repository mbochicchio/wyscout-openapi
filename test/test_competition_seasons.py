...
class TestCompetitionSeasons(unittest.TestCase):
    """CompetitionSeasons unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CompetitionSeasons:
        """Test CompetitionSeasons
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CompetitionSeasons`
        """
        model = CompetitionSeasons()
        if include_optional:
            return CompetitionSeasons(
                ...
                competition_id = 56,
                seasons = [
                    openapi_client.models.the_list_of_season_inner.The_list_of_season_inner(
    ...
    def testCompetitionSeasons(self):
        """Test CompetitionSeasons"""
