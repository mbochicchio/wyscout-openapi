...
class TestTeamMatchesMatchesInner(unittest.TestCase):
    """TeamMatchesMatchesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TeamMatchesMatchesInner:
        """Test TeamMatchesMatchesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TeamMatchesMatchesInner`
        """
        model = TeamMatchesMatchesInner()
        if include_optional:
            return TeamMatchesMatchesInner(
                competition_id = 56,
                var_date = '',
                dateutc = '',
                gameweek = 56,
    ...
    def testTeamMatchesMatchesInner(self):
        """Test TeamMatchesMatchesInner"""
