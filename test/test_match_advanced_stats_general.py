...
class TestMatchAdvancedStatsGeneral(unittest.TestCase):
    """MatchAdvancedStatsGeneral unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatchAdvancedStatsGeneral:
        """Test MatchAdvancedStatsGeneral
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatchAdvancedStatsGeneral`
        """
        model = MatchAdvancedStatsGeneral()
        if include_optional:
            return MatchAdvancedStatsGeneral(
                avg_distance = 1.337,
                corners = 56,
                dribbles = 56,
                fouls = 56,
    ...
    def testMatchAdvancedStatsGeneral(self):
        """Test MatchAdvancedStatsGeneral"""
