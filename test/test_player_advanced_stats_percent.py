...
class TestPlayerAdvancedStatsPercent(unittest.TestCase):
    """PlayerAdvancedStatsPercent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PlayerAdvancedStatsPercent:
        """Test PlayerAdvancedStatsPercent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PlayerAdvancedStatsPercent`
        """
        model = PlayerAdvancedStatsPercent()
        if include_optional:
            return PlayerAdvancedStatsPercent(
                aerial_duels_won = 56,
    ...
    def testPlayerAdvancedStatsPercent(self):
        """Test PlayerAdvancedStatsPercent"""
