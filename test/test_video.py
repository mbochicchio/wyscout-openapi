...
class TestVideo(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Video:
        ...
        if include_optional:
            return Video(
                fullhd = openapi_client.models.quality_url.QualityUrl(
                    url = null, ),
                hd = openapi_client.models.quality_url.QualityUrl(
                    url = null, ),
                lq = openapi_client.models.quality_url.QualityUrl(
                    url = null, ),
                match_id = 56,
                offsets = openapi_client.models.information_about_video_offsets.Information about video offsets(
                    1_h = openapi_client.models.offset.Offset(
                        end = 56, 
                        start = 56, ), 
                    2_h = openapi_client.models.offset.Offset(
                        end = 56, 
                        start = 56, ), 
                    ...
                    p = openapi_client.models.offset.Offset(
                        ...
                        start = 56, ), ),
                sd = openapi_client.models.quality_url.QualityUrl(
                    url = null, )
            )
        else:
            return Video(
