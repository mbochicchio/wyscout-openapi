...
class TestErrorCode429(unittest.TestCase):
    """ErrorCode429 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ErrorCode429:
        """Test ErrorCode429
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ErrorCode429`
        """
        model = ErrorCode429()
        if include_optional:
            return ErrorCode429(
                error = openapi_client.models.error_object.Error object(
                    code = 56, 
                    message = '', )
            )
        else:
