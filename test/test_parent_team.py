...
class TestParentTeam(unittest.TestCase):
    """ParentTeam unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ParentTeam:
        """Test ParentTeam
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ParentTeam`
        """
        model = ParentTeam()
        if include_optional:
            return ParentTeam(
