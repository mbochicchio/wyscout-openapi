...
class TestRelatedTeamsInner(unittest.TestCase):
    """RelatedTeamsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RelatedTeamsInner:
        """Test RelatedTeamsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RelatedTeamsInner`
        """
        model = RelatedTeamsInner()
        if include_optional:
            return RelatedTeamsInner(
                name = '',
                wy_id = 56
            )
        else:
    ...
    def testRelatedTeamsInner(self):
        """Test RelatedTeamsInner"""
