...
class TestMatchFormations(unittest.TestCase):
    """MatchFormations unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatchFormations:
        """Test MatchFormations
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatchFormations`
        """
        model = MatchFormations()
        if include_optional:
            return MatchFormations(
                away = [
                    openapi_client.models.match_formation.MatchFormation(
                        end_sec = 56, 
                        id = 56, 
                        match_period_end = '1H', 
