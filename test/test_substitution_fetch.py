...
class TestSubstitutionFetch(unittest.TestCase):
    """SubstitutionFetch unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubstitutionFetch:
        """Test SubstitutionFetch
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubstitutionFetch`
        """
        model = SubstitutionFetch()
        if include_optional:
            return SubstitutionFetch(
    ...
    def testSubstitutionFetch(self):
        """Test SubstitutionFetch"""
