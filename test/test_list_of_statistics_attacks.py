...
class TestListOfStatisticsAttacks(unittest.TestCase):
    """ListOfStatisticsAttacks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListOfStatisticsAttacks:
        """Test ListOfStatisticsAttacks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListOfStatisticsAttacks`
        """
        model = ListOfStatisticsAttacks()
        if include_optional:
            return ListOfStatisticsAttacks(
    ...
    def testListOfStatisticsAttacks(self):
        """Test ListOfStatisticsAttacks"""
