...
class TestTeamMatchAdvancedStats(unittest.TestCase):
    """TeamMatchAdvancedStats unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TeamMatchAdvancedStats:
        """Test TeamMatchAdvancedStats
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TeamMatchAdvancedStats`
        """
        model = TeamMatchAdvancedStats()
        if include_optional:
            return TeamMatchAdvancedStats(
    ...
    def testTeamMatchAdvancedStats(self):
        """Test TeamMatchAdvancedStats"""
