...
class TestListOfStatisticsFlanks(unittest.TestCase):
    """ListOfStatisticsFlanks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListOfStatisticsFlanks:
        """Test ListOfStatisticsFlanks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListOfStatisticsFlanks`
        """
        model = ListOfStatisticsFlanks()
        if include_optional:
            return ListOfStatisticsFlanks(
    ...
    def testListOfStatisticsFlanks(self):
        """Test ListOfStatisticsFlanks"""
