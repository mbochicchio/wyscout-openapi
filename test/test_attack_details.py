...
class TestAttackDetails(unittest.TestCase):
    """AttackDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AttackDetails:
        """Test AttackDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AttackDetails`
        """
        model = AttackDetails()
        if include_optional:
