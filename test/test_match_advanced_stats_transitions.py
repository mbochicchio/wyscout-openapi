...
class TestMatchAdvancedStatsTransitions(unittest.TestCase):
    """MatchAdvancedStatsTransitions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatchAdvancedStatsTransitions:
        """Test MatchAdvancedStatsTransitions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatchAdvancedStatsTransitions`
        """
        model = MatchAdvancedStatsTransitions()
        if include_optional:
            return MatchAdvancedStatsTransitions(
                losses_high = 56,
                losses_low = 56,
                losses_medium = 56,
                losses_total = 56,
    ...
    def testMatchAdvancedStatsTransitions(self):
        """Test MatchAdvancedStatsTransitions"""
