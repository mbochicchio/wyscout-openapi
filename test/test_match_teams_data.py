...
class TestMatchTeamsData(unittest.TestCase):
    """MatchTeamsData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatchTeamsData:
        """Test MatchTeamsData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatchTeamsData`
        """
        model = MatchTeamsData()
        if include_optional:
            return MatchTeamsData(
                team_aid = openapi_client.models.match_team_data.MatchTeamData(
                    coach = null, 
                    coach_id = 56, 
                    ...
                    team_id = 56, ),
                team_bid = openapi_client.models.match_team_data.MatchTeamData(
                    coach = null, 
                    coach_id = 56, 
                    formation = openapi_client.models.team_lineup,_benched,_substitutions.Team lineup, benched, substitutions(
                        bench = [
