...
class TestPassDetails(unittest.TestCase):
    """PassDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PassDetails:
        """Test PassDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PassDetails`
        """
        model = PassDetails()
        if include_optional:
            return PassDetails(
