...
class TestSeasonScorers(unittest.TestCase):
    """SeasonScorers unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SeasonScorers:
        """Test SeasonScorers
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SeasonScorers`
        """
        model = SeasonScorers()
        if include_optional:
            return SeasonScorers(
