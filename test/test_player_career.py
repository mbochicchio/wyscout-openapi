...
class TestPlayerCareer(unittest.TestCase):
    """PlayerCareer unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PlayerCareer:
        """Test PlayerCareer
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PlayerCareer`
        """
        model = PlayerCareer()
        if include_optional:
            return PlayerCareer(
                career = [
                    openapi_client.models.the_items_schema.The items schema(
                        appearances = 56, 
                        competition = null, 
                        competition_id = 56, 
                        goal = 56, 
