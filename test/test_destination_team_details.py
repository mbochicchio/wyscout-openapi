...
class TestDestinationTeamDetails(unittest.TestCase):
    """DestinationTeamDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DestinationTeamDetails:
        """Test DestinationTeamDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DestinationTeamDetails`
        """
        model = DestinationTeamDetails()
        if include_optional:
            return DestinationTeamDetails(
    ...
    def testDestinationTeamDetails(self):
        """Test DestinationTeamDetails"""
