...
class TestCoachesFetch(unittest.TestCase):
    """CoachesFetch unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CoachesFetch:
        """Test CoachesFetch
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CoachesFetch`
        """
        model = CoachesFetch()
        if include_optional:
            return CoachesFetch(
