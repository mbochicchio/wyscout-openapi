...
class TestMatchAdvancedStatsDuels(unittest.TestCase):
    """MatchAdvancedStatsDuels unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatchAdvancedStatsDuels:
        """Test MatchAdvancedStatsDuels
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatchAdvancedStatsDuels`
        """
        model = MatchAdvancedStatsDuels()
        if include_optional:
            return MatchAdvancedStatsDuels(
                aerial_duels = 56,
    ...
    def testMatchAdvancedStatsDuels(self):
        """Test MatchAdvancedStatsDuels"""
