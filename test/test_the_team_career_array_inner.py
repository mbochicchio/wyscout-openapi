...
class TestTheTeamCareerArrayInner(unittest.TestCase):
    """TheTeamCareerArrayInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TheTeamCareerArrayInner:
        """Test TheTeamCareerArrayInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TheTeamCareerArrayInner`
        """
        model = TheTeamCareerArrayInner()
        if include_optional:
            return TheTeamCareerArrayInner(
    ...
    def testTheTeamCareerArrayInner(self):
        """Test TheTeamCareerArrayInner"""
