...
class TestTheLqObject(unittest.TestCase):
    """TheLqObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TheLqObject:
        """Test TheLqObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TheLqObject`
        """
        model = TheLqObject()
        if include_optional:
            return TheLqObject(
