...
class TestPlayersFetch(unittest.TestCase):
    """PlayersFetch unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PlayersFetch:
        """Test PlayersFetch
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PlayersFetch`
        """
        model = PlayersFetch()
        if include_optional:
            return PlayersFetch(
