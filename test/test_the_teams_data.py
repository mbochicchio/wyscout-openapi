...
class TestTheTeamsData(unittest.TestCase):
    """TheTeamsData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TheTeamsData:
        """Test TheTeamsData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TheTeamsData`
        """
        model = TheTeamsData()
        if include_optional:
            return TheTeamsData(
