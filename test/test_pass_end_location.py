...
class TestPassEndLocation(unittest.TestCase):
    """PassEndLocation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PassEndLocation:
        """Test PassEndLocation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PassEndLocation`
        """
        model = PassEndLocation()
        if include_optional:
            return PassEndLocation(
                x = 56,
                y = 56
            )
        else:
