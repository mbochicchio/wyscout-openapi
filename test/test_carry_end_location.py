...
class TestCarryEndLocation(unittest.TestCase):
    """CarryEndLocation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CarryEndLocation:
        """Test CarryEndLocation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CarryEndLocation`
        """
        model = CarryEndLocation()
        if include_optional:
            return CarryEndLocation(
                x = 56,
                y = 56
            )
        else:
