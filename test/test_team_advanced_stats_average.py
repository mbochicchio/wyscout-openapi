...
class TestTeamAdvancedStatsAverage(unittest.TestCase):
    """TeamAdvancedStatsAverage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TeamAdvancedStatsAverage:
        """Test TeamAdvancedStatsAverage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TeamAdvancedStatsAverage`
        """
        model = TeamAdvancedStatsAverage()
        if include_optional:
            return TeamAdvancedStatsAverage(
                accelerations = 1.337,
                aerial_duels = 1.337,
                assists = 1.337,
    ...
    def testTeamAdvancedStatsAverage(self):
        """Test TeamAdvancedStatsAverage"""
