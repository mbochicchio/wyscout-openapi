...
class TestFormationsFetch(unittest.TestCase):
    """FormationsFetch unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FormationsFetch:
        """Test FormationsFetch
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FormationsFetch`
        """
        model = FormationsFetch()
        if include_optional:
            return FormationsFetch(
