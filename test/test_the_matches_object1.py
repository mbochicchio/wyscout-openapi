...
class TestTheMatchesObject1(unittest.TestCase):
    """TheMatchesObject1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TheMatchesObject1:
        """Test TheMatchesObject1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TheMatchesObject1`
        """
        model = TheMatchesObject1()
        if include_optional:
            return TheMatchesObject1(
                competition_id = 56,
                var_date = '',
                dateutc = '',
                gameweek = 56,
    ...
    def testTheMatchesObject1(self):
        """Test TheMatchesObject1"""
