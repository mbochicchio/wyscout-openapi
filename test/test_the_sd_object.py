...
class TestTheSdObject(unittest.TestCase):
    """TheSdObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TheSdObject:
        """Test TheSdObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TheSdObject`
        """
        model = TheSdObject()
        if include_optional:
            return TheSdObject(
