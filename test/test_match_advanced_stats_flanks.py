...
class TestMatchAdvancedStatsFlanks(unittest.TestCase):
    """MatchAdvancedStatsFlanks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatchAdvancedStatsFlanks:
        """Test MatchAdvancedStatsFlanks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatchAdvancedStatsFlanks`
        """
        model = MatchAdvancedStatsFlanks()
        if include_optional:
            return MatchAdvancedStatsFlanks(
                center_attacks = 56,
                center_xg = 1.337,
    ...
    def testMatchAdvancedStatsFlanks(self):
        """Test MatchAdvancedStatsFlanks"""
