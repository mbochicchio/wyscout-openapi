...
class TestMatchAdvancedStatsDefence(unittest.TestCase):
    """MatchAdvancedStatsDefence unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatchAdvancedStatsDefence:
        """Test MatchAdvancedStatsDefence
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatchAdvancedStatsDefence`
        """
        model = MatchAdvancedStatsDefence()
        if include_optional:
            return MatchAdvancedStatsDefence(
                clearances = 56,
                interceptions = 56,
                ppda = 1.337,
                tackles = 56
    ...
    def testMatchAdvancedStatsDefence(self):
        """Test MatchAdvancedStatsDefence"""
