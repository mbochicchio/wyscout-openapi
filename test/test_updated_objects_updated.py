...
class TestUpdatedObjectsUpdated(unittest.TestCase):
    """UpdatedObjectsUpdated unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdatedObjectsUpdated:
        """Test UpdatedObjectsUpdated
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdatedObjectsUpdated`
        """
        model = UpdatedObjectsUpdated()
        if include_optional:
            return UpdatedObjectsUpdated(
                resource_type = openapi_client.models.the_resource_object.The resource object(
                    <resource_id> = null, ),
    ...
    def testUpdatedObjectsUpdated(self):
        """Test UpdatedObjectsUpdated"""
