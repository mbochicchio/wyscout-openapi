...
class TestVideosApi(unittest.TestCase):
    ...
    def test_videos_match_id_get(self) -> None:
        """Test case for videos_match_id_get

        Videos
        """
        pass

    def test_videos_match_id_offsets_get(self) -> None:
        """Test case for videos_match_id_offsets_get

        Videos offsets
        """
        pass

    def test_videos_match_id_qualities_get(self) -> None:
        """Test case for videos_match_id_qualities_get
