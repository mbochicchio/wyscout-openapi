...
class TestPassRecipient(unittest.TestCase):
    """PassRecipient unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PassRecipient:
        """Test PassRecipient
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PassRecipient`
        """
        model = PassRecipient()
        if include_optional:
            return PassRecipient(
                id = 56,
                name = '',
                position = ''
            )
