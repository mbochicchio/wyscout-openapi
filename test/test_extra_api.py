...
class TestExtraApi(unittest.TestCase):
    """ExtraApi unit test stubs"""
    ...
    def test_updatedobjects_deleted_get(self) -> None:
        """Test case for updatedobjects_deleted_get

        Updated Objects deleted
        """
        pass

    def test_updatedobjects_updated_get(self) -> None:
        """Test case for updatedobjects_updated_get
