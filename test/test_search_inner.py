...
class TestSearchInner(unittest.TestCase):
    """SearchInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SearchInner:
        """Test SearchInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SearchInner`
        """
        model = SearchInner()
        if include_optional:
            return SearchInner(
