...
class TestVideoQualities(unittest.TestCase):
    """VideoQualities unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VideoQualities:
        """Test VideoQualities
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VideoQualities`
        """
        model = VideoQualities()
        if include_optional:
            return VideoQualities(
                fullhd = openapi_client.models.the_fullhd_object.The fullhd object(
                    is_available = True, ),
                hd = openapi_client.models.the_hd_object.The hd object(
                    is_available = True, ),
                lq = openapi_client.models.the_lq_object.The lq object(
                    is_available = True, ),
                match_id = 56,
                sd = openapi_client.models.the_sd_object.The sd object(
                    is_available = True, )
            )
        else:
            return VideoQualities(
