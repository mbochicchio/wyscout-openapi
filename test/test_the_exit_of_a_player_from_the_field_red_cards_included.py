...
class TestTheExitOfAPlayerFromTheFieldRedCardsIncluded(unittest.TestCase):
    """TheExitOfAPlayerFromTheFieldRedCardsIncluded unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TheExitOfAPlayerFromTheFieldRedCardsIncluded:
        """Test TheExitOfAPlayerFromTheFieldRedCardsIncluded
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TheExitOfAPlayerFromTheFieldRedCardsIncluded`
        """
        model = TheExitOfAPlayerFromTheFieldRedCardsIncluded()
        if include_optional:
            return TheExitOfAPlayerFromTheFieldRedCardsIncluded(
                player_id = 56
            )
        else:
            return TheExitOfAPlayerFromTheFieldRedCardsIncluded(
    ...
    def testTheExitOfAPlayerFromTheFieldRedCardsIncluded(self):
        """Test TheExitOfAPlayerFromTheFieldRedCardsIncluded"""
