...
class TestShotDetails(unittest.TestCase):
    """ShotDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ShotDetails:
        """Test ShotDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ShotDetails`
        """
        model = ShotDetails()
        if include_optional:
            return ShotDetails(
