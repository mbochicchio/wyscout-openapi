...
class TestListOfStatisticsGeneral(unittest.TestCase):
    """ListOfStatisticsGeneral unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListOfStatisticsGeneral:
        """Test ListOfStatisticsGeneral
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListOfStatisticsGeneral`
        """
        model = ListOfStatisticsGeneral()
        if include_optional:
            return ListOfStatisticsGeneral(
    ...
    def testListOfStatisticsGeneral(self):
        """Test ListOfStatisticsGeneral"""
