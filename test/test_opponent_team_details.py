...
class TestOpponentTeamDetails(unittest.TestCase):
    """OpponentTeamDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OpponentTeamDetails:
        """Test OpponentTeamDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OpponentTeamDetails`
        """
        model = OpponentTeamDetails()
        if include_optional:
            return OpponentTeamDetails(
                formation = '',
                id = 56,
                name = ''
            )
    ...
    def testOpponentTeamDetails(self):
        """Test OpponentTeamDetails"""
