...
class TestPlayerAdvancedStatsAverage(unittest.TestCase):
    """PlayerAdvancedStatsAverage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PlayerAdvancedStatsAverage:
        """Test PlayerAdvancedStatsAverage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PlayerAdvancedStatsAverage`
        """
        model = PlayerAdvancedStatsAverage()
        if include_optional:
            return PlayerAdvancedStatsAverage(
                accelerations = 1.337,
                aerial_duels = 1.337,
                assists = 1.337,
    ...
    def testPlayerAdvancedStatsAverage(self):
        """Test PlayerAdvancedStatsAverage"""
