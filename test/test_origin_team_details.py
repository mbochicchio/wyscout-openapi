...
class TestOriginTeamDetails(unittest.TestCase):
    """OriginTeamDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OriginTeamDetails:
        """Test OriginTeamDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OriginTeamDetails`
        """
        model = OriginTeamDetails()
        if include_optional:
            return OriginTeamDetails(
    ...
    def testOriginTeamDetails(self):
        """Test OriginTeamDetails"""
