...
class TestSeasonCareer(unittest.TestCase):
    """SeasonCareer unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SeasonCareer:
        """Test SeasonCareer
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SeasonCareer`
        """
        model = SeasonCareer()
        if include_optional:
            return SeasonCareer(
                ...
                rounds = [
                    openapi_client.models.round_data.Round data(
                        groups = [
                            openapi_client.models.group_standings.Group standings(
                                teams = [
                                    openapi_client.models.teams_standing_for_the_group.Teams standing for the group(
                                        competition_id = 56, 
                                        game_draw = 56, 
                                        game_lost = 56, 
                                        game_total = 56, 
