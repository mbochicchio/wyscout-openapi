...
class TestMatchPhysicalDataInnerPlayersInnerMetricsInnerValuesInner(unittest.TestCase):
    """MatchPhysicalDataInnerPlayersInnerMetricsInnerValuesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatchPhysicalDataInnerPlayersInnerMetricsInnerValuesInner:
        """Test MatchPhysicalDataInnerPlayersInnerMetricsInnerValuesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatchPhysicalDataInnerPlayersInnerMetricsInnerValuesInner`
        """
        model = MatchPhysicalDataInnerPlayersInnerMetricsInnerValuesInner()
        if include_optional:
            return MatchPhysicalDataInnerPlayersInnerMetricsInnerValuesInner(
                phase = '',
                value = 1.337
            )
        else:
    ...
    def testMatchPhysicalDataInnerPlayersInnerMetricsInnerValuesInner(self):
        """Test MatchPhysicalDataInnerPlayersInnerMetricsInnerValuesInner"""
