...
class TestInformationAboutVideoOffsets(unittest.TestCase):
    """InformationAboutVideoOffsets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InformationAboutVideoOffsets:
        """Test InformationAboutVideoOffsets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InformationAboutVideoOffsets`
        """
        model = InformationAboutVideoOffsets()
        if include_optional:
            return InformationAboutVideoOffsets(
                var_1_h = openapi_client.models.offset.Offset(
                    end = 56, 
                    start = 56, ),
                var_2_h = openapi_client.models.offset.Offset(
                    end = 56, 
                    start = 56, ),
                e1 = openapi_client.models.offset.Offset(
                    end = 56, 
                    start = 56, ),
                e2 = openapi_client.models.offset.Offset(
                    end = 56, 
                    start = 56, ),
                p = openapi_client.models.offset.Offset(
                    end = 56, 
                    start = 56, )
            )
        else:
    ...
    def testInformationAboutVideoOffsets(self):
        """Test InformationAboutVideoOffsets"""
