...
class TestTheResourceObject(unittest.TestCase):
    """TheResourceObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TheResourceObject:
        """Test TheResourceObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TheResourceObject`
        """
        model = TheResourceObject()
        if include_optional:
            return TheResourceObject(
                resource_id = None
            )
        else:
            return TheResourceObject(
    ...
    def testTheResourceObject(self):
        """Test TheResourceObject"""
