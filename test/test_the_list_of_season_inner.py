...
class TestTheListOfSeasonInner(unittest.TestCase):
    """TheListOfSeasonInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TheListOfSeasonInner:
        """Test TheListOfSeasonInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TheListOfSeasonInner`
        """
        model = TheListOfSeasonInner()
        if include_optional:
            return TheListOfSeasonInner(
    ...
    def testTheListOfSeasonInner(self):
        """Test TheListOfSeasonInner"""
