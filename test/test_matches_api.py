...
class TestMatchesApi(unittest.TestCase):
    ...
    def test_matches_wy_id_directions_get(self) -> None:
        """Test case for matches_wy_id_directions_get

        Match directions
        """
        pass

    def test_matches_wy_id_formations_get(self) -> None:
        """Test case for matches_wy_id_formations_get

        Match formations
        """
        pass

    def test_matches_wy_id_get(self) -> None:
        """Test case for matches_wy_id_get
