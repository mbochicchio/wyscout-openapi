...
class TestTheTeamObject(unittest.TestCase):
    """TheTeamObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TheTeamObject:
        """Test TheTeamObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TheTeamObject`
        """
        model = TheTeamObject()
        if include_optional:
            return TheTeamObject(
                group_name = '',
