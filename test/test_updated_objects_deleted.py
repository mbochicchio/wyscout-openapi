...
class TestUpdatedObjectsDeleted(unittest.TestCase):
    """UpdatedObjectsDeleted unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdatedObjectsDeleted:
        """Test UpdatedObjectsDeleted
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdatedObjectsDeleted`
        """
        model = UpdatedObjectsDeleted()
        if include_optional:
            return UpdatedObjectsDeleted(
                resource_type = [
                    56
                    ],
    ...
    def testUpdatedObjectsDeleted(self):
        """Test UpdatedObjectsDeleted"""
