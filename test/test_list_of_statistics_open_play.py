...
class TestListOfStatisticsOpenPlay(unittest.TestCase):
    """ListOfStatisticsOpenPlay unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListOfStatisticsOpenPlay:
        """Test ListOfStatisticsOpenPlay
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListOfStatisticsOpenPlay`
        """
        model = ListOfStatisticsOpenPlay()
        if include_optional:
            return ListOfStatisticsOpenPlay(
    ...
    def testListOfStatisticsOpenPlay(self):
        """Test ListOfStatisticsOpenPlay"""
