...
class TestTeamAdvancedStatsPercent(unittest.TestCase):
    """TeamAdvancedStatsPercent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TeamAdvancedStatsPercent:
        """Test TeamAdvancedStatsPercent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TeamAdvancedStatsPercent`
        """
        model = TeamAdvancedStatsPercent()
        if include_optional:
            return TeamAdvancedStatsPercent(
                aerial_duels_won = 56,
    ...
    def testTeamAdvancedStatsPercent(self):
        """Test TeamAdvancedStatsPercent"""
