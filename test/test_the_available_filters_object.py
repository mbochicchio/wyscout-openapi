...
class TestTheAvailableFiltersObject(unittest.TestCase):
    """TheAvailableFiltersObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TheAvailableFiltersObject:
        """Test TheAvailableFiltersObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TheAvailableFiltersObject`
        """
        model = TheAvailableFiltersObject()
        if include_optional:
            return TheAvailableFiltersObject(
                advsearches = [
                    ''
                    ],
                fetches = [
    ...
    def testTheAvailableFiltersObject(self):
        """Test TheAvailableFiltersObject"""
