...
class TestTeamsFetch(unittest.TestCase):
    """TeamsFetch unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TeamsFetch:
        """Test TeamsFetch
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TeamsFetch`
        """
        model = TeamsFetch()
        if include_optional:
            return TeamsFetch(
