...
class TestTeamSubstitutionsInner(unittest.TestCase):
    """TeamSubstitutionsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TeamSubstitutionsInner:
        """Test TeamSubstitutionsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TeamSubstitutionsInner`
        """
        model = TeamSubstitutionsInner()
        if include_optional:
            return TeamSubstitutionsInner(
                assists = '',
                minute = 56,
                player_in = 56,
                player_out = 56
    ...
    def testTeamSubstitutionsInner(self):
        """Test TeamSubstitutionsInner"""
