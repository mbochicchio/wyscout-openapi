...
class TestGoalkeeperDetails(unittest.TestCase):
    """GoalkeeperDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoalkeeperDetails:
        """Test GoalkeeperDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoalkeeperDetails`
        """
        model = GoalkeeperDetails()
        if include_optional:
            return GoalkeeperDetails(
                id = 56,
                name = ''
            )
        else:
    ...
    def testGoalkeeperDetails(self):
        """Test GoalkeeperDetails"""
