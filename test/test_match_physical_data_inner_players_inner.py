...
class TestMatchPhysicalDataInnerPlayersInner(unittest.TestCase):
    """MatchPhysicalDataInnerPlayersInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatchPhysicalDataInnerPlayersInner:
        """Test MatchPhysicalDataInnerPlayersInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatchPhysicalDataInnerPlayersInner`
        """
        model = MatchPhysicalDataInnerPlayersInner()
        if include_optional:
            return MatchPhysicalDataInnerPlayersInner(
                id = '',
                metrics = [
    ...
    def testMatchPhysicalDataInnerPlayersInner(self):
        """Test MatchPhysicalDataInnerPlayersInner"""
