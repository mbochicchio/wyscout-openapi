...
class TestTheItemsSchema(unittest.TestCase):
    """TheItemsSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TheItemsSchema:
        """Test TheItemsSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TheItemsSchema`
        """
        model = TheItemsSchema()
        if include_optional:
