...
class TestMatchRefereesInner(unittest.TestCase):
    """MatchRefereesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatchRefereesInner:
        """Test MatchRefereesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatchRefereesInner`
        """
        model = MatchRefereesInner()
        if include_optional:
            return MatchRefereesInner(
                referee = {"birthArea":{"alpha2code":"IT","alpha3code":"ITA","id":380,"name":"Italy"},"birthDate":"1973-05-21","firstName":"Andrea","gender":"male","gsmId":44752,"imageDataURL":"data:image/png;base64,","lastName":"De Marco","middleName":"","passportArea":{"alpha2code":"IT","alpha3code":"ITA","id":380,"name":"Italy"},"shortName":"A. De Marco","status":"active","wyId":377208},
                referee_id = 56,
                role = 'referee'
            )
        else:
    ...
    def testMatchRefereesInner(self):
        """Test MatchRefereesInner"""
