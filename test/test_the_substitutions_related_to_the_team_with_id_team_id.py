...
class TestTheSubstitutionsRelatedToTheTeamWithIDTeamId(unittest.TestCase):
    """TheSubstitutionsRelatedToTheTeamWithIDTeamId unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TheSubstitutionsRelatedToTheTeamWithIDTeamId:
        """Test TheSubstitutionsRelatedToTheTeamWithIDTeamId
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TheSubstitutionsRelatedToTheTeamWithIDTeamId`
        """
        model = TheSubstitutionsRelatedToTheTeamWithIDTeamId()
        if include_optional:
            return TheSubstitutionsRelatedToTheTeamWithIDTeamId(
    ...
    def testTheSubstitutionsRelatedToTheTeamWithIDTeamId(self):
        """Test TheSubstitutionsRelatedToTheTeamWithIDTeamId"""
