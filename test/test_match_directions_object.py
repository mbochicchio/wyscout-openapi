...
class TestMatchDirectionsObject(unittest.TestCase):
    """MatchDirectionsObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatchDirectionsObject:
        """Test MatchDirectionsObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatchDirectionsObject`
        """
        model = MatchDirectionsObject()
        if include_optional:
            return MatchDirectionsObject(
    ...
    def testMatchDirectionsObject(self):
        """Test MatchDirectionsObject"""
