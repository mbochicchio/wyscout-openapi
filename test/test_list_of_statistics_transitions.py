...
class TestListOfStatisticsTransitions(unittest.TestCase):
    """ListOfStatisticsTransitions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListOfStatisticsTransitions:
        """Test ListOfStatisticsTransitions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListOfStatisticsTransitions`
        """
        model = ListOfStatisticsTransitions()
        if include_optional:
            return ListOfStatisticsTransitions(
    ...
    def testListOfStatisticsTransitions(self):
        """Test ListOfStatisticsTransitions"""
