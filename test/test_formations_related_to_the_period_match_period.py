...
class TestFormationsRelatedToThePeriodMatchPeriod(unittest.TestCase):
    """FormationsRelatedToThePeriodMatchPeriod unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FormationsRelatedToThePeriodMatchPeriod:
        """Test FormationsRelatedToThePeriodMatchPeriod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FormationsRelatedToThePeriodMatchPeriod`
        """
        model = FormationsRelatedToThePeriodMatchPeriod()
        if include_optional:
            return FormationsRelatedToThePeriodMatchPeriod(
    ...
    def testFormationsRelatedToThePeriodMatchPeriod(self):
        """Test FormationsRelatedToThePeriodMatchPeriod"""
