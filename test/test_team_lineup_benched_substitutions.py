...
class TestTeamLineupBenchedSubstitutions(unittest.TestCase):
    """TeamLineupBenchedSubstitutions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TeamLineupBenchedSubstitutions:
        """Test TeamLineupBenchedSubstitutions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TeamLineupBenchedSubstitutions`
        """
        model = TeamLineupBenchedSubstitutions()
        if include_optional:
            return TeamLineupBenchedSubstitutions(
                bench = [
    ...
    def testTeamLineupBenchedSubstitutions(self):
        """Test TeamLineupBenchedSubstitutions"""
