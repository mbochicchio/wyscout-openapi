...
class TestCarryDetails(unittest.TestCase):
    """CarryDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CarryDetails:
        """Test CarryDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CarryDetails`
        """
        model = CarryDetails()
        if include_optional:
            return CarryDetails(
