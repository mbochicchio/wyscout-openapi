...
class TestTheSeasonMatchObject(unittest.TestCase):
    """TheSeasonMatchObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TheSeasonMatchObject:
        """Test TheSeasonMatchObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TheSeasonMatchObject`
        """
        model = TheSeasonMatchObject()
        if include_optional:
            return TheSeasonMatchObject(
                competition_id = 56,
                var_date = '',
                dateutc = '',
                gameweek = 56,
    ...
    def testTheSeasonMatchObject(self):
        """Test TheSeasonMatchObject"""
