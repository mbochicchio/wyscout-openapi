...
class TestOpponentDetails1(unittest.TestCase):
    """OpponentDetails1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OpponentDetails1:
        """Test OpponentDetails1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OpponentDetails1`
        """
        model = OpponentDetails1()
        if include_optional:
            return OpponentDetails1(
                id = 56,
                name = '',
                position = ''
            )
