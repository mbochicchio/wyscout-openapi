...
class TestPlayerFixtures(unittest.TestCase):
    """PlayerFixtures unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PlayerFixtures:
        """Test PlayerFixtures
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PlayerFixtures`
        """
        model = PlayerFixtures()
        if include_optional:
            return PlayerFixtures(
                matches = [
                    openapi_client.models.the_matches_object.The matches object(
                        competition_id = 56, 
                        date = '', 
                        dateutc = '', 
                        gameweek = 56, 
