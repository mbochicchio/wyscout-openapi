...
class TestTheVideoURL(unittest.TestCase):
    """TheVideoURL unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TheVideoURL:
        """Test TheVideoURL
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TheVideoURL`
        """
        model = TheVideoURL()
        if include_optional:
            return TheVideoURL(
