...
class TestSeasonMatches(unittest.TestCase):
    """SeasonMatches unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SeasonMatches:
        """Test SeasonMatches
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SeasonMatches`
        """
        model = SeasonMatches()
        if include_optional:
            return SeasonMatches(
                matches = [
                    openapi_client.models.the_season_match_object.The season match object(
                        competition_id = 56, 
                        date = '', 
                        dateutc = '', 
                        gameweek = 56, 
