...
class TestTheFullhdObject(unittest.TestCase):
    """TheFullhdObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TheFullhdObject:
        """Test TheFullhdObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TheFullhdObject`
        """
        model = TheFullhdObject()
        if include_optional:
            return TheFullhdObject(
                is_available = True
            )
        else:
            return TheFullhdObject(
