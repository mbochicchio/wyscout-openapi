...
class TestAdvancedStatsApi(unittest.TestCase):
    """AdvancedStatsApi unit test stubs"""

    def setUp(self) -> None:
        self.api = AdvancedStatsApi()

    def tearDown(self) -> None:
        pass

    def test_matches_wy_id_advancedstats_get(self) -> None:
        """Test case for matches_wy_id_advancedstats_get

        Match Advanced Stats
        """
        pass

    def test_matches_wy_id_advancedstats_players_get(self) -> None:
        """Test case for matches_wy_id_advancedstats_players_get

        All players Match Advanced Stats
        """
        pass

    def test_players_wy_id_advancedstats_get(self) -> None:
        """Test case for players_wy_id_advancedstats_get

        Player Advanced Stats
        """
        pass

    def test_players_wy_id_matches_match_wy_id_advancedstats_get(self) -> None:
        """Test case for players_wy_id_matches_match_wy_id_advancedstats_get

        Players match advanced stats
        """
        pass

    def test_teams_wy_id_advancedstats_get(self) -> None:
        """Test case for teams_wy_id_advancedstats_get

        Teams Advanced Stats
        """
        pass

    def test_teams_wy_id_matches_match_wy_id_advancedstats_get(self) -> None:
        """Test case for teams_wy_id_matches_match_wy_id_advancedstats_get
