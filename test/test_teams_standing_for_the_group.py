...
class TestTeamsStandingForTheGroup(unittest.TestCase):
    """TeamsStandingForTheGroup unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TeamsStandingForTheGroup:
        """Test TeamsStandingForTheGroup
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TeamsStandingForTheGroup`
        """
        model = TeamsStandingForTheGroup()
        if include_optional:
            return TeamsStandingForTheGroup(
                competition_id = 56,
                game_draw = 56,
                game_lost = 56,
                game_total = 56,
    ...
    def testTeamsStandingForTheGroup(self):
        """Test TeamsStandingForTheGroup"""
