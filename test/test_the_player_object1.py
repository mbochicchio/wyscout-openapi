...
class TestThePlayerObject1(unittest.TestCase):
    """ThePlayerObject1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ThePlayerObject1:
        """Test ThePlayerObject1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ThePlayerObject1`
        """
        model = ThePlayerObject1()
        if include_optional:
            return ThePlayerObject1(
                goals = 56,
