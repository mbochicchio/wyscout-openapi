...
class TestErrorCode500(unittest.TestCase):
    """ErrorCode500 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ErrorCode500:
        """Test ErrorCode500
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ErrorCode500`
        """
        model = ErrorCode500()
        if include_optional:
            return ErrorCode500(
