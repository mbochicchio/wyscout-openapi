...
class TestTheRefereeObject(unittest.TestCase):
    """TheRefereeObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TheRefereeObject:
        """Test TheRefereeObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TheRefereeObject`
        """
        model = TheRefereeObject()
        if include_optional:
            return TheRefereeObject(
                referee_id = 56,
                role = ''
            )
        else:
