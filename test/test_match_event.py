...
class TestMatchEvent(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> MatchEvent:
        """Test MatchEvent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatchEvent`
        """
        model = MatchEvent()
        if include_optional:
            return MatchEvent(
                ...
                opponent_team = openapi_client.models.opponent_team_details.Opponent team details(
                    ...
                    id = 56, 
                    name = '', ),
                var_pass = openapi_client.models.pass_details.Pass details(
                    accurate = True, 
                    angle = 56, 
                    end_location = openapi_client.models.pass_end_location.Pass end location(
                        x = 56, 
                        y = 56, ), 
                    length = 1.337, 
