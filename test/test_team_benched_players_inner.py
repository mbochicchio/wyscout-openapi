...
class TestTeamBenchedPlayersInner(unittest.TestCase):
    """TeamBenchedPlayersInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TeamBenchedPlayersInner:
        """Test TeamBenchedPlayersInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TeamBenchedPlayersInner`
        """
        model = TeamBenchedPlayersInner()
        if include_optional:
            return TeamBenchedPlayersInner(
                assists = '',
                goals = '',
                own_goals = '',
    ...
    def testTeamBenchedPlayersInner(self):
        """Test TeamBenchedPlayersInner"""
