...
class TestOffset3(unittest.TestCase):
    """Offset3 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Offset3:
        """Test Offset3
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Offset3`
        """
        model = Offset3()
        if include_optional:
            return Offset3(
