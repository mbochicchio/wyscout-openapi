...
class TestThePlayerObject(unittest.TestCase):
    """ThePlayerObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ThePlayerObject:
        """Test ThePlayerObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ThePlayerObject`
        """
        model = ThePlayerObject()
        if include_optional:
            return ThePlayerObject(
                assists = 56,
