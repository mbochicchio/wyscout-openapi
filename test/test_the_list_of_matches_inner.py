...
class TestTheListOfMatchesInner(unittest.TestCase):
    """TheListOfMatchesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TheListOfMatchesInner:
        """Test TheListOfMatchesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TheListOfMatchesInner`
        """
        model = TheListOfMatchesInner()
        if include_optional:
            return TheListOfMatchesInner(
                competition_id = 56,
                var_date = '',
                dateutc = '',
                gameweek = 56,
    ...
    def testTheListOfMatchesInner(self):
        """Test TheListOfMatchesInner"""
