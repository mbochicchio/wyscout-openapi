...
class TestTheSubstitutionsRelatedToMatchPeriodMatchPeriod(unittest.TestCase):
    """TheSubstitutionsRelatedToMatchPeriodMatchPeriod unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TheSubstitutionsRelatedToMatchPeriodMatchPeriod:
        """Test TheSubstitutionsRelatedToMatchPeriodMatchPeriod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TheSubstitutionsRelatedToMatchPeriodMatchPeriod`
        """
        model = TheSubstitutionsRelatedToMatchPeriodMatchPeriod()
        if include_optional:
            return TheSubstitutionsRelatedToMatchPeriodMatchPeriod(
    ...
    def testTheSubstitutionsRelatedToMatchPeriodMatchPeriod(self):
        """Test TheSubstitutionsRelatedToMatchPeriodMatchPeriod"""
