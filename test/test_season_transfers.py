...
class TestSeasonTransfers(unittest.TestCase):
    """SeasonTransfers unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SeasonTransfers:
        """Test SeasonTransfers
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SeasonTransfers`
        """
        model = SeasonTransfers()
        if include_optional:
