...
class TestGroundDuelDetails(unittest.TestCase):
    """GroundDuelDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GroundDuelDetails:
        """Test GroundDuelDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GroundDuelDetails`
        """
        model = GroundDuelDetails()
        if include_optional:
            return GroundDuelDetails(
                duel_type = '',
    ...
    def testGroundDuelDetails(self):
        """Test GroundDuelDetails"""
