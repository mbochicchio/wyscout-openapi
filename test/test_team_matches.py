...
class TestTeamMatches(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TeamMatches:
        """Test TeamMatches
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TeamMatches`
        """
        model = TeamMatches()
        if include_optional:
            return TeamMatches(
                matches = [
                    openapi_client.models.team_matches_matches_inner.TeamMatches_matches_inner(
                        competition_id = 56, 
                        date = '', 
                        dateutc = '', 
                        gameweek = 56, 
