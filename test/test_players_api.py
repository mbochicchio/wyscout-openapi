...
class TestPlayersApi(unittest.TestCase):
    ...
    def test_players_wy_id_career_get(self) -> None:
        """Test case for players_wy_id_career_get

        Players career
        """
        pass

    def test_players_wy_id_contractinfo_get(self) -> None:
        """Test case for players_wy_id_contractinfo_get

        Players contract info
        """
        pass

    def test_players_wy_id_fixtures_get(self) -> None:
        """Test case for players_wy_id_fixtures_get

        Players fixtures
        """
        pass

    def test_players_wy_id_get(self) -> None:
        """Test case for players_wy_id_get

        Player details
        """
        pass

    def test_players_wy_id_matches_get(self) -> None:
        """Test case for players_wy_id_matches_get

        Players matches
        """
        pass

    def test_players_wy_id_transfers_get(self) -> None:
        """Test case for players_wy_id_transfers_get
