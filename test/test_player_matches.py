...
class TestPlayerMatches(unittest.TestCase):
    """PlayerMatches unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PlayerMatches:
        """Test PlayerMatches
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PlayerMatches`
        """
        model = PlayerMatches()
        if include_optional:
