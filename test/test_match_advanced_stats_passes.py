...
class TestMatchAdvancedStatsPasses(unittest.TestCase):
    """MatchAdvancedStatsPasses unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatchAdvancedStatsPasses:
        """Test MatchAdvancedStatsPasses
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatchAdvancedStatsPasses`
        """
        model = MatchAdvancedStatsPasses()
        if include_optional:
            return MatchAdvancedStatsPasses(
                assists = 56,
    ...
    def testMatchAdvancedStatsPasses(self):
        """Test MatchAdvancedStatsPasses"""
