...
class TestTheTransferObject1(unittest.TestCase):
    """TheTransferObject1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TheTransferObject1:
        """Test TheTransferObject1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TheTransferObject1`
        """
        model = TheTransferObject1()
        if include_optional:
            return TheTransferObject1(
                active = 56,
                announce_date = '',
                currency = 'USD',
                end_date = '',
    ...
    def testTheTransferObject1(self):
        """Test TheTransferObject1"""
