...
class TestTeamsApi(unittest.TestCase):
    ...
    def test_teams_wy_id_career_get(self) -> None:
        """Test case for teams_wy_id_career_get

        Team careers
        """
        pass

    def test_teams_wy_id_fixtures_get(self) -> None:
        """Test case for teams_wy_id_fixtures_get

        Teams fixtures
        """
        pass

    def test_teams_wy_id_get(self) -> None:
        """Test case for teams_wy_id_get

        Team details
        """
        pass

    def test_teams_wy_id_matches_get(self) -> None:
        """Test case for teams_wy_id_matches_get

        Teams matches
        """
        pass

    def test_teams_wy_id_squad_get(self) -> None:
        """Test case for teams_wy_id_squad_get

        Teams squad
        """
        pass

    def test_teams_wy_id_transfers_get(self) -> None:
        """Test case for teams_wy_id_transfers_get
