...
class TestInfractionDetails(unittest.TestCase):
    """InfractionDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InfractionDetails:
        """Test InfractionDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InfractionDetails`
        """
        model = InfractionDetails()
        if include_optional:
    ...
    def testInfractionDetails(self):
        """Test InfractionDetails"""
