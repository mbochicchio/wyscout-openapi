...
class TestOffset5(unittest.TestCase):
    """Offset5 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Offset5:
        """Test Offset5
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Offset5`
        """
        model = Offset5()
        if include_optional:
            return Offset5(
