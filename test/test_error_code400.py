...
class TestErrorCode400(unittest.TestCase):
    """ErrorCode400 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ErrorCode400:
        """Test ErrorCode400
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ErrorCode400`
        """
        model = ErrorCode400()
        if include_optional:
            return ErrorCode400(
