...
class TestPlayerMatchAdvancedStats(unittest.TestCase):
    """PlayerMatchAdvancedStats unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PlayerMatchAdvancedStats:
        """Test PlayerMatchAdvancedStats
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PlayerMatchAdvancedStats`
        """
        model = PlayerMatchAdvancedStats()
        if include_optional:
            return PlayerMatchAdvancedStats(
                average = openapi_client.models.list_of_statistics,_averages.List of statistics, averages(
                    accelerations = 1.337, 
                    aerial_duels = 1.337, 
                    assists = 1.337, 
                    ...
                    back_passes = 1.337, 
                    ball_losses = 1.337, 
                    ball_recoveries = 1.337, 
                    clearances = 1.337, 
                    corners = 1.337, 
                    counterpressing_recoveries = 1.337, 
                    crosses = 1.337, 
                    ...
                    dribble_distance_from_opponent_goal = 1.337, 
                    dribbles = 1.337, 
                    dribbles_against = 1.337, 
                    dribbles_against_won = 1.337, 
                    duels = 1.337, 
                    duels_won = 1.337, 
                    ...
                    goal_kicks = 1.337, 
                    goal_kicks_long = 1.337, 
                    goal_kicks_short = 1.337, 
                    goals = 1.337, 
                    head_shots = 1.337, 
                    interceptions = 1.337, 
                    key_passes = 1.337, 
                    ...
                    penalties = 1.337, 
                    progressive_passes = 1.337, 
                    progressive_run = 1.337, 
                    received_pass = 1.337, 
                    red_cards = 1.337, 
                    second_assists = 1.337, 
                    shot_assists = 1.337, 
                    shot_on_target_assists = 1.337, 
                    shots = 1.337, 
                    shots_blocked = 1.337, 
                    shots_on_target = 1.337, 
                    sliding_tackles = 1.337, 
                    smart_passes = 1.337, 
                    ...
                    successful_progressive_passes = 1.337, 
                ...
                match_id = 56,
                percent = openapi_client.models.list_of_statistics,_percentages.List of statistics, percentages(
                    aerial_duels_won = 56, 
                    defensive_duels_won = 1.337, 
                    direct_free_kicks_on_target = 1.337, 
                    ...
                    gk_saves = 56, 
                    gk_successful_exits = 56, 
                    goal_conversion = 1.337, 
                    head_shots_on_target = 56, 
                    new_defensive_duels_won = 56, 
                    new_duels_won = 56, 
                    new_offensive_duels_won = 56, 
                    new_successful_dribbles = 56, 
                    offensive_duels_won = 1.337, 
                    penalties_conversion = 56, 
                    shots_on_target = 1.337, 
                    successful_back_passes = 1.337, 
                    successful_crosses = 1.337, 
                    successful_dribbles = 1.337, 
                    ...
                    successful_passes_to_final_third = 1.337, 
                    successful_progressive_passes = 1.337, 
                    successful_shot_assists = 56, 
                    successful_sliding_tackles = 1.337, 
                    successful_smart_passes = 1.337, 
                    successful_through_passes = 1.337, 
                    successful_vertical_passes = 1.337, 
                    win = 1.337, 
                    yellow_cards_per_foul = 56, ),
                ...
                player_id = 56,
                positions = [
                    openapi_client.models.player_advanced_stats_position.Player Advanced Stats Position(
                        percent = 56, 
                ...
                season_id = 56,
                total = openapi_client.models.list_of_statistics,_total_numbers.List of statistics, total numbers(
                    accelerations = 56, 
                    aerial_duels = 56, 
                    aerial_duels_won = 56, 
                    assists = 56, 
    ...
    def testPlayerMatchAdvancedStats(self):
        """Test PlayerMatchAdvancedStats"""
