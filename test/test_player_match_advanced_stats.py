        ...
        if include_optional:
            return PlayerMatchAdvancedStats(
                average = openapi_client.models.list_of_statistics,_averages.List of statistics, averages(
                    ...
                    gk_conceded_goals = 1.337, 
                    gk_exits = 1.337, 
                    gk_saves = 1.337, 
                    gk_shots_against = 1.337, 
                ...
                percent = openapi_client.models.list_of_statistics,_percentages.List of statistics, percentages(
                    ...
                    head_shots_on_target = 1.337, 
                    new_defensive_duels_won = 1.337, 
                    new_duels_won = 1.337, 
                    new_offensive_duels_won = 1.337, 
                    new_successful_dribbles = 1.337, 
                    offensive_duels_won = 1.337, 
                    penalties_conversion = 1.337, 
                    shots_on_target = 1.337, 
                    successful_back_passes = 1.337, 
                    successful_crosses = 1.337, 
                    successful_dribbles = 1.337, 
                    ...
                    successful_passes_to_final_third = 1.337, 
                    successful_progressive_passes = 1.337, 
                    successful_shot_assists = 1.337, 
                    successful_sliding_tackles = 1.337, 
                    successful_smart_passes = 1.337, 
                    successful_through_passes = 1.337, 
                    successful_vertical_passes = 1.337, 
                    win = 1.337, 
                    yellow_cards_per_foul = 1.337, ),
                ...
                total = openapi_client.models.list_of_statistics,_total_numbers.List of statistics, total numbers(
                    ...
                    losses = 1.337, 
                    matches = 1.337, 
                    matches_coming_off = 1.337, 
                    matches_in_start = 1.337, 
                    matches_substituted = 1.337, 
                    minutes_on_field = 1.337, 
                    minutes_tagged = 1.337, 
                    missed_balls = 1.337, 
                    new_defensive_duels_won = 1.337, 
                    new_duels_won = 1.337, 
                    new_offensive_duels_won = 1.337, 
