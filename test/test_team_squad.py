...
class TestTeamSquad(unittest.TestCase):
    """TeamSquad unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TeamSquad:
        """Test TeamSquad
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TeamSquad`
        """
        model = TeamSquad()
        if include_optional:
            return TeamSquad(
                coach = [
                    {"birthArea":{"alpha2code":"IT","alpha3code":"ITA","id":380,"name":"Italy"},"birthDate":"1967-08-11","currentTeamId":3159,"firstName":"Massimiliano","gender":"male","gsmId":110817,"imageDataURL":"https://cdn5.wyscout.com/photos/players/public/g110817_100x130.png","lastName":"Allegri","middleName":"","passportArea":{"alpha2code":"IT","alpha3code":"ITA","id":380,"name":"Italy"},"shortName":"M. Allegri","status":"active","type":"coach","wyId":20386}
                    ],
                squad = [
