...
**gk_aerial_duels** | **float** | &lt;i&gt;Only Goalkeeper&lt;/i&gt; | [optional] 
**gk_aerial_duels_won** | **float** | &lt;i&gt;Only Goalkeeper&lt;/i&gt; | [optional] 
**gk_clean_sheets** | **float** | Matches with no goals conceded, &lt;i&gt;Only Goalkeeper&lt;/i&gt; | [optional] 
**gk_conceded_goals** | **float** | A goal scored by an opponent as specified in law 10.1 of the IFAB Laws of the Game, &lt;i&gt;Only Goalkeeper&lt;/i&gt; | [optional] 
**gk_exits** | **float** | &lt;i&gt;Only Goalkeeper&lt;/i&gt; | [optional] 
**gk_saves** | **float** | &lt;i&gt;Only Goalkeeper&lt;/i&gt; | [optional] 
