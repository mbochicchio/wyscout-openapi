...
**clean_sheets** | **float** | Matches with no goals conceded | [optional] 
**conceded_goals** | **float** | A goal scored by an opponent as specified in law 10.1 of the IFAB Laws of the Game. | [optional] 
...
**field_aerial_duels** | **float** |  | [optional] 
...
**gk_aerial_duels** | **float** | When two or more players from opposing teams jump to compete for the ball, &lt;i&gt;Only Goalkeeper&lt;/i&gt; | [optional] 
**gk_aerial_duels_won** | **float** | &lt;i&gt;Only Goalkeeper&lt;/i&gt; | [optional] 
**gk_exits** | **float** | &lt;i&gt;Only Goalkeeper&lt;/i&gt; | [optional] 
**gk_goal_kicks** | **float** | A goal kick according to law 16 of the IFAB Laws of the Game | [optional] 
**gk_goal_kicks_success** | **float** |  | [optional] 
